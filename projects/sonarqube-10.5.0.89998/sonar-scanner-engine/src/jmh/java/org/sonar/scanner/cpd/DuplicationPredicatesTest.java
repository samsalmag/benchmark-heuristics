...
public class DuplicationPredicatesTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_testNumberOfUnitsNotLessThan() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testNumberOfUnitsNotLessThan, this.description("testNumberOfUnitsNotLessThan"));
        }

        private DuplicationPredicatesTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new DuplicationPredicatesTest();
        }

        @java.lang.Override
        public DuplicationPredicatesTest implementation() {

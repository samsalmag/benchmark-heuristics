...
public class ExtensionInstallerTest {
    ...
    public void should_filter_extensions_to_install() {
        ...
        assertThat(container.getAddedObjects()).contains(Foo.class).doesNotContain(Bar.class);
    }
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_should_filter_extensions_to_install() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_filter_extensions_to_install, this.description("should_filter_extensions_to_install"));
        }

        private ExtensionInstallerTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ExtensionInstallerTest();
        }

        @java.lang.Override
        public ExtensionInstallerTest implementation() {

...
public class ProjectRepositoriesProviderTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_testValidation() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testValidation, this.description("testValidation"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_testAssociated() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testAssociated, this.description("testAssociated"));
        }
        ...
        private ProjectRepositoriesProviderTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ProjectRepositoriesProviderTest();
        }

        @java.lang.Override
        public ProjectRepositoriesProviderTest implementation() {

...
public class AnalysisWarningsPublisherTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_publish_warnings() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::publish_warnings, this.description("publish_warnings"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_do_not_write_warnings_report_when_empty() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::do_not_write_warnings_report_when_empty, this.description("do_not_write_warnings_report_when_empty"));
        }
        ...
        private AnalysisWarningsPublisherTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new AnalysisWarningsPublisherTest();
        }

        @java.lang.Override
        public AnalysisWarningsPublisherTest implementation() {

...
public class DefaultProjectSettingsLoaderTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_loadProjectSettings() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::loadProjectSettings, this.description("loadProjectSettings"));
        }

        private DefaultProjectSettingsLoaderTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new DefaultProjectSettingsLoaderTest();
        }

        @java.lang.Override
        public DefaultProjectSettingsLoaderTest implementation() {

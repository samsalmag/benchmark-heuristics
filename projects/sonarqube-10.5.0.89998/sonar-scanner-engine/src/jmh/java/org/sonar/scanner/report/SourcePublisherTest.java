...
public class SourcePublisherTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_publishEmptySource() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::publishEmptySource, this.description("publishEmptySource"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_publishSourceWithLastEmptyLine() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::publishSourceWithLastEmptyLine, this.description("publishSourceWithLastEmptyLine"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_publishTestSource() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::publishTestSource, this.description("publishTestSource"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_publishSourceWithLastLineNotEmpty() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::publishSourceWithLastLineNotEmpty, this.description("publishSourceWithLastLineNotEmpty"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_cleanLineEnds() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::cleanLineEnds, this.description("cleanLineEnds"));
        }
        ...
        private SourcePublisherTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SourcePublisherTest();
        }

        @java.lang.Override
        public SourcePublisherTest implementation() {

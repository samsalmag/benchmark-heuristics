...
public class ModuleCoverageAndDuplicationExclusionsTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_shouldExcludeFileBasedOnPattern() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldExcludeFileBasedOnPattern, this.description("shouldExcludeFileBasedOnPattern"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldNotExcludeFileBasedOnPattern() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldNotExcludeFileBasedOnPattern, this.description("shouldNotExcludeFileBasedOnPattern"));
        }
        ...
        private ModuleCoverageAndDuplicationExclusionsTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ModuleCoverageAndDuplicationExclusionsTest();
        }

        @java.lang.Override
        public ModuleCoverageAndDuplicationExclusionsTest implementation() {

...
public class ChangedFileTest {
    ...
    private DefaultIndexedFile composeDefaultIndexFile(Path path, String oldRelativePath) {
        return new DefaultIndexedFile(path, random(5), random(5), random(5), InputFile.Type.MAIN, random(5), Integer.parseInt(randomNumeric(5)), new SensorStrategy(), oldRelativePath);
    }
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_test_unMovedFile() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::test_unMovedFile, this.description("test_unMovedFile"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_test_movedFile() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::test_movedFile, this.description("test_movedFile"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_test_equalsAndHashCode() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::test_equalsAndHashCode, this.description("test_equalsAndHashCode"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_test_changed_file_is_created_properly_from_default_input_file() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::test_changed_file_is_created_properly_from_default_input_file, this.description("test_changed_file_is_created_properly_from_default_input_file"));
        }

        private ChangedFileTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ChangedFileTest();
        }

        @java.lang.Override
        public ChangedFileTest implementation() {

...
public class LanguageTest {
    ...
    public void hashCode_and_equals_depends_on_key() {
        ...
        assertThat(lang1).hasSameHashCodeAs(lang2).doesNotHaveSameHashCodeAs(lang3);
        assertThat(lang2).doesNotHaveSameHashCodeAs(lang3);
        assertThat(lang1).isEqualTo(lang2).isNotEqualTo(lang3);
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_hashCode_and_equals_depends_on_key() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::hashCode_and_equals_depends_on_key, this.description("hashCode_and_equals_depends_on_key"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_getters_match_constructor() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::getters_match_constructor, this.description("getters_match_constructor"));
        }

        private LanguageTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new LanguageTest();
        }

        @java.lang.Override
        public LanguageTest implementation() {

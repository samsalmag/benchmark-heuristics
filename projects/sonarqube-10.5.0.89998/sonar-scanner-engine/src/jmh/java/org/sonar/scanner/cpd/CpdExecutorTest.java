...
public class CpdExecutorTest {
    ...
    public void should_limit_number_of_references() {
        ...
        assertThat(logTester.logs(Level.WARN)).contains("Too many duplication references on file " + batchComponent1 + " for block at line 0. Keep only the first " + CpdExecutor.MAX_CLONE_PART_PER_GROUP + " references.");
    }
    ...
    public void should_limit_number_of_clones() {
        ...
        assertThat(logTester.logs(Level.WARN)).contains("Too many duplication groups on file " + batchComponent1 + ". Keep only the first " + CpdExecutor.MAX_CLONE_GROUP_PER_FILE + " groups.");
    }
    ...
    public void should_timeout() {
        ...
        executor.execute(1);
        readDuplications(0);
        assertThat(logTester.logs(Level.WARN)).usingElementComparator((l, r) -> l.matches(r) ? 0 : 1).containsOnly("Timeout during detection of duplications for .*Foo.php");
    }
    ...
    private DefaultInputFile createComponent(String relativePath, int lines, Consumer<TestInputFileBuilder> config) {
        TestInputFileBuilder fileBuilder = new TestInputFileBuilder("foo", relativePath).setModuleBaseDir(baseDir.toPath()).setLines(lines);
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_dont_fail_if_nothing_to_save() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::dont_fail_if_nothing_to_save, this.description("dont_fail_if_nothing_to_save"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_save_single_duplication() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_save_single_duplication, this.description("should_save_single_duplication"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_save_duplication_on_same_file() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_save_duplication_on_same_file, this.description("should_save_duplication_on_same_file"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_limit_number_of_references() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_limit_number_of_references, this.description("should_limit_number_of_references"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_limit_number_of_clones() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_limit_number_of_clones, this.description("should_limit_number_of_clones"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_save_duplication_involving_three_files() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_save_duplication_involving_three_files, this.description("should_save_duplication_involving_three_files"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_save_two_duplicated_groups_involving_three_files() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_save_two_duplicated_groups_involving_three_files, this.description("should_save_two_duplicated_groups_involving_three_files"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_ignore_missing_component() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_ignore_missing_component, this.description("should_ignore_missing_component"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_timeout() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_timeout, this.description("should_timeout"));
        }
        ...
        private CpdExecutorTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new CpdExecutorTest();
        }

        @java.lang.Override
        public CpdExecutorTest implementation() {

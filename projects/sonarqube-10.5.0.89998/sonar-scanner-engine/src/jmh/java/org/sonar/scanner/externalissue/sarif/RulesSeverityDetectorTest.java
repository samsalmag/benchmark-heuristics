...
public class RulesSeverityDetectorTest {
    ...
    private static void assertDetectedRuleSeverities(Map<String, String> severities, Tuple... expectedSeverities) {
        Assertions.assertThat(severities.entrySet()).extracting(Map.Entry::getKey, Map.Entry::getValue).containsExactly(expectedSeverities);
    }

    private void assertWarningLog(String defaultSeverity) {
        assertThat(logTester.logs(Level.WARN)).contains(format("Unable to detect rules severity for issue detected by tool %s, falling back to default rule severity: %s", DRIVER_NAME, defaultSeverity));
    }
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_detectRulesSeverities_detectsCorrectlyResultDefinedRuleSeverities() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::detectRulesSeverities_detectsCorrectlyResultDefinedRuleSeverities, this.description("detectRulesSeverities_detectsCorrectlyResultDefinedRuleSeverities"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_detectRulesSeveritiesForNewTaxonomy_shouldReturnsEmptyMapAndLogsWarning_whenOnlyResultDefinedRuleSeverities() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::detectRulesSeveritiesForNewTaxonomy_shouldReturnsEmptyMapAndLogsWarning_whenOnlyResultDefinedRuleSeverities, this.description("detectRulesSeveritiesForNewTaxonomy_shouldReturnsEmptyMapAndLogsWarning_whenOnlyResultDefinedRuleSeverities"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_detectRulesSeverities_detectsCorrectlyDriverDefinedRuleSeverities() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::detectRulesSeverities_detectsCorrectlyDriverDefinedRuleSeverities, this.description("detectRulesSeverities_detectsCorrectlyDriverDefinedRuleSeverities"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_detectRulesSeverities_detectsCorrectlyExtensionsDefinedRuleSeverities() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::detectRulesSeverities_detectsCorrectlyExtensionsDefinedRuleSeverities, this.description("detectRulesSeverities_detectsCorrectlyExtensionsDefinedRuleSeverities"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_detectRulesSeverities_returnsEmptyMapAndLogsWarning_whenUnableToDetectSeverities() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::detectRulesSeverities_returnsEmptyMapAndLogsWarning_whenUnableToDetectSeverities, this.description("detectRulesSeverities_returnsEmptyMapAndLogsWarning_whenUnableToDetectSeverities"));
        }
        ...
        private RulesSeverityDetectorTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new RulesSeverityDetectorTest();
        }

        @java.lang.Override
        public RulesSeverityDetectorTest implementation() {

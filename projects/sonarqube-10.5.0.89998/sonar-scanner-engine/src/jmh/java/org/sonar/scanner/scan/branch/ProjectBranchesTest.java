...
public class ProjectBranchesTest {
    ...
    public static Object[][] branchNamesAndBranches() {
        return allBranches.stream().map(b -> new Object[] { b.name(), b }).toArray(Object[][]::new);
    }
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_defaultBranchName() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::defaultBranchName, this.description("defaultBranchName"));
        }
        ...
        private ProjectBranchesTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ProjectBranchesTest();
        }

        @java.lang.Override
        public ProjectBranchesTest implementation() {

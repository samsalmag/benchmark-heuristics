...
public class DefaultGlobalSettingsLoaderTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_loadGlobalSettings() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::loadGlobalSettings, this.description("loadGlobalSettings"));
        }

        private DefaultGlobalSettingsLoaderTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new DefaultGlobalSettingsLoaderTest();
        }

        @java.lang.Override
        public DefaultGlobalSettingsLoaderTest implementation() {

...
public class ModuleSensorExtensionDictionaryTest {
    ...
    public void annotatedMethodsCanNotBePrivate() {
        ModuleSensorExtensionDictionary selector = new ModuleSensorExtensionDictionary(mock(ExtensionContainer.class), mock(ModuleSensorContext.class), sensorOptimizer, fileSystem, branchConfiguration);
    ...
    @ScannerSide
    static class MethodDependentOf implements Marker {
    ...
    @ScannerSide
    @DependsUpon("flag")
    static class ClassDependsUpon implements Marker {
    }

    @ScannerSide
    @DependedUpon("flag")
    static class ClassDependedUpon implements Marker {
    }
    ...
    @ScannerSide
    static class GeneratesSomething implements Marker {
    ...
    static class PreSensor implements Sensor {
    ...
    static class PostSensor implements Sensor {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_testGetFilteredExtensionWithExtensionMatcher() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testGetFilteredExtensionWithExtensionMatcher, this.description("testGetFilteredExtensionWithExtensionMatcher"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_testGetFilteredExtensions() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testGetFilteredExtensions, this.description("testGetFilteredExtensions"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldSearchInParentContainers() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldSearchInParentContainers, this.description("shouldSearchInParentContainers"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_sortExtensionsByDependency() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::sortExtensionsByDependency, this.description("sortExtensionsByDependency"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_useMethodAnnotationsToSortExtensions() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::useMethodAnnotationsToSortExtensions, this.description("useMethodAnnotationsToSortExtensions"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_methodDependsUponCollection() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::methodDependsUponCollection, this.description("methodDependsUponCollection"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_methodDependsUponArray() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::methodDependsUponArray, this.description("methodDependsUponArray"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_useClassAnnotationsToSortExtensions() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::useClassAnnotationsToSortExtensions, this.description("useClassAnnotationsToSortExtensions"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_useClassAnnotationsOnInterfaces() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::useClassAnnotationsOnInterfaces, this.description("useClassAnnotationsOnInterfaces"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_inheritAnnotations() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::inheritAnnotations, this.description("inheritAnnotations"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_annotatedMethodsCanNotBePrivate() throws java.lang.Throwable {
            this.createImplementation();
            this.runExceptionBenchmark(this.implementation()::annotatedMethodsCanNotBePrivate, this.description("annotatedMethodsCanNotBePrivate"), java.lang.IllegalStateException.class);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_dependsUponPhaseForSensors() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::dependsUponPhaseForSensors, this.description("dependsUponPhaseForSensors"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_dependsUponInheritedPhase() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::dependsUponInheritedPhase, this.description("dependsUponInheritedPhase"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_selectSensors() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::selectSensors, this.description("selectSensors"));
        }
        ...
        private ModuleSensorExtensionDictionaryTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ModuleSensorExtensionDictionaryTest();
        }

        @java.lang.Override
        public ModuleSensorExtensionDictionaryTest implementation() {

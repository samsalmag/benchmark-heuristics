...
public class GenericTestExecutionReportParserTest {
    ...
    private DefaultInputFile setupFile(String path) {
        return new TestInputFileBuilder(context.module().key(), path).setLanguage("bla").setType(InputFile.Type.TEST).initMetadata("1\n2\n3\n4\n5\n6").build();
    }
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_ut_empty_file() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::ut_empty_file, this.description("ut_empty_file"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_file_with_unittests() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::file_with_unittests, this.description("file_with_unittests"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_unittest_invalid_root_node_name() throws java.lang.Throwable {
            this.createImplementation();
            this.runExceptionBenchmark(this.implementation()::unittest_invalid_root_node_name, this.description("unittest_invalid_root_node_name"), org.sonar.api.utils.MessageException.class);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_unittest_invalid_report_version() throws java.lang.Throwable {
            this.createImplementation();
            this.runExceptionBenchmark(this.implementation()::unittest_invalid_report_version, this.description("unittest_invalid_report_version"), org.sonar.api.utils.MessageException.class);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_unittest_duration_in_testCase_should_not_be_negative() throws java.lang.Throwable {
            this.createImplementation();
            this.runExceptionBenchmark(this.implementation()::unittest_duration_in_testCase_should_not_be_negative, this.description("unittest_duration_in_testCase_should_not_be_negative"), org.sonar.api.utils.MessageException.class);
        }
        ...
        private GenericTestExecutionReportParserTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new GenericTestExecutionReportParserTest();
        }

        @java.lang.Override
        public GenericTestExecutionReportParserTest implementation() {

...
public class ModuleSensorOptimizerTest {
    ...
    public void should_optimize_on_repository() {
        DefaultSensorDescriptor descriptor = new DefaultSensorDescriptor().createIssuesForRuleRepositories("java");
        assertThat(optimizer.shouldExecute(descriptor)).isFalse();
        ...
        assertThat(optimizer.shouldExecute(descriptor)).isFalse();
        activeRules = new ActiveRulesBuilder().addRule(new NewActiveRule.Builder().setRuleKey(RuleKey.of("repo1", "foo")).build()).addRule(new NewActiveRule.Builder().setRuleKey(RuleKey.of("java", "rule")).build()).build();
        optimizer = new ModuleSensorOptimizer(fs, activeRules, settings.asConfig());
        assertThat(optimizer.shouldExecute(descriptor)).isTrue();
    }
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_optimize_on_language() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_optimize_on_language, this.description("should_optimize_on_language"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_optimize_on_type() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_optimize_on_type, this.description("should_optimize_on_type"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_optimize_on_both_type_and_language() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_optimize_on_both_type_and_language, this.description("should_optimize_on_both_type_and_language"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_optimize_on_repository() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_optimize_on_repository, this.description("should_optimize_on_repository"));
        }
        ...
        private ModuleSensorOptimizerTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ModuleSensorOptimizerTest();
        }

        @java.lang.Override
        public ModuleSensorOptimizerTest implementation() {

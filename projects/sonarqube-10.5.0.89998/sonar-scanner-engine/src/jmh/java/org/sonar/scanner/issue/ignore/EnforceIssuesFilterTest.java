...
public class EnforceIssuesFilterTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_shouldPassToChainIfNoConfiguredPatterns() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldPassToChainIfNoConfiguredPatterns, this.description("shouldPassToChainIfNoConfiguredPatterns"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldPassToChainIfRuleDoesNotMatch() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldPassToChainIfRuleDoesNotMatch, this.description("shouldPassToChainIfRuleDoesNotMatch"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldAcceptIssueIfFullyMatched() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldAcceptIssueIfFullyMatched, this.description("shouldAcceptIssueIfFullyMatched"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldAcceptIssueIfMatchesDeprecatedRuleKey() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldAcceptIssueIfMatchesDeprecatedRuleKey, this.description("shouldAcceptIssueIfMatchesDeprecatedRuleKey"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldRefuseIssueIfRuleMatchesButNotPath() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldRefuseIssueIfRuleMatchesButNotPath, this.description("shouldRefuseIssueIfRuleMatchesButNotPath"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldRefuseIssueIfRuleMatchesAndNotFile() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldRefuseIssueIfRuleMatchesAndNotFile, this.description("shouldRefuseIssueIfRuleMatchesAndNotFile"));
        }
        ...
        private EnforceIssuesFilterTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new EnforceIssuesFilterTest();
        }

        @java.lang.Override
        public EnforceIssuesFilterTest implementation() {

...
public class ExtensionUtilsTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_shouldBeBatchInstantiationStrategy() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldBeBatchInstantiationStrategy, this.description("shouldBeBatchInstantiationStrategy"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldBeProjectInstantiationStrategy() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldBeProjectInstantiationStrategy, this.description("shouldBeProjectInstantiationStrategy"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_testIsScannerSide() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testIsScannerSide, this.description("testIsScannerSide"));
        }

        private ExtensionUtilsTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ExtensionUtilsTest();
        }

        @java.lang.Override
        public ExtensionUtilsTest implementation() {

...
public class CpdSettingsTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_defaultMinimumTokens() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::defaultMinimumTokens, this.description("defaultMinimumTokens"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_minimumTokensByLanguage() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::minimumTokensByLanguage, this.description("minimumTokensByLanguage"));
        }
        ...
        private CpdSettingsTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new CpdSettingsTest();
        }

        @java.lang.Override
        public CpdSettingsTest implementation() {

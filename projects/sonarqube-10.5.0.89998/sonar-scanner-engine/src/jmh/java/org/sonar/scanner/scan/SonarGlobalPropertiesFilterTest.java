...
public class SonarGlobalPropertiesFilterTest {
    ...
    public void should_filterSonarGlobalProperties() {
        Map<String, String> settingProperties = Map.of(SONAR_GLOBAL_KEY_1, "shouldBeOverride", SONAR_GLOBAL_KEY_2, "shouldBeRemove", SONAR_NON_GLOBAL_KEY_4, SONAR_NON_GLOBAL_VALUE_4, ANOTHER_KEY, ANOTHER_VALUE);
        Map<String, String> globalServerSettingsProperties = Map.of(SONAR_GLOBAL_KEY_1, SONAR_GLOBAL_VALUE_1, SONAR_GLOBAL_KEY_3, SONAR_GLOBAL_VALUE_3, SONAR_NON_GLOBAL_KEY_4, "shouldBeIgnored");
        ...
        assertThat(properties).hasSize(4).containsEntry(SONAR_GLOBAL_KEY_1, SONAR_GLOBAL_VALUE_1).containsEntry(SONAR_GLOBAL_KEY_3, SONAR_GLOBAL_VALUE_3).containsEntry(SONAR_NON_GLOBAL_KEY_4, SONAR_NON_GLOBAL_VALUE_4).containsEntry(ANOTHER_KEY, ANOTHER_VALUE);
    }
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_should_filterSonarGlobalProperties() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_filterSonarGlobalProperties, this.description("should_filterSonarGlobalProperties"));
        }

        private SonarGlobalPropertiesFilterTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SonarGlobalPropertiesFilterTest();
        }

        @java.lang.Override
        public SonarGlobalPropertiesFilterTest implementation() {

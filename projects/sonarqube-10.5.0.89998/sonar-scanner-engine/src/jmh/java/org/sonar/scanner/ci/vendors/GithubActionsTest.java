...
public class GithubActionsTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_log_warning_if_missing_GITHUB_SHA() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::log_warning_if_missing_GITHUB_SHA, this.description("log_warning_if_missing_GITHUB_SHA"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_loadConfiguration_whenMissingGitHubEnvironmentVariables_shouldLogWarn() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::loadConfiguration_whenMissingGitHubEnvironmentVariables_shouldLogWarn, this.description("loadConfiguration_whenMissingGitHubEnvironmentVariables_shouldLogWarn"));
        }
        ...
        private GithubActionsTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new GithubActionsTest();
        }

        @java.lang.Override
        public GithubActionsTest implementation() {

...
public class DefaultQualityProfileLoaderTest {
    ...
    public void load_throws_MessageException_if_no_profiles_are_available_for_specified_project() throws IOException {
        ...
        assertThatThrownBy(() -> underTest.load("project")).isInstanceOf(MessageException.class).hasMessageContaining("No quality profiles");
    }
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_load_gets_all_profiles_for_specified_project() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::load_gets_all_profiles_for_specified_project, this.description("load_gets_all_profiles_for_specified_project"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_load_encodes_url_parameters() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::load_encodes_url_parameters, this.description("load_encodes_url_parameters"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_load_tries_default_if_no_profiles_found_for_project() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::load_tries_default_if_no_profiles_found_for_project, this.description("load_tries_default_if_no_profiles_found_for_project"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_load_throws_MessageException_if_no_profiles_are_available_for_specified_project() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::load_throws_MessageException_if_no_profiles_are_available_for_specified_project, this.description("load_throws_MessageException_if_no_profiles_are_available_for_specified_project"));
        }

        private DefaultQualityProfileLoaderTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new DefaultQualityProfileLoaderTest();
        }

        @java.lang.Override
        public DefaultQualityProfileLoaderTest implementation() {

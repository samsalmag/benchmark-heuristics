...
public class ScannerCoreExtensionsInstallerTest {
    ...
    public void install_only_adds_ScannerSide_annotated_extension_to_container() {
        when(coreExtensionRepository.loadedCoreExtensions()).thenReturn(Stream.of(new CoreExtension() {
            ...
            public void load(Context context) {
                context.addExtensions(CeClass.class, ScannerClass.class, WebServerClass.class, NoAnnotationClass.class, OtherAnnotationClass.class, MultipleAnnotationClass.class);
            }
        }));
        ListContainer container = new ListContainer();
        underTest.install(container, noExtensionFilter(), noAdditionalSideFilter());
        assertThat(container.getAddedObjects()).hasSize(2).contains(ScannerClass.class, MultipleAnnotationClass.class);
    }
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_install_only_adds_ScannerSide_annotated_extension_to_container() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::install_only_adds_ScannerSide_annotated_extension_to_container, this.description("install_only_adds_ScannerSide_annotated_extension_to_container"));
        }

        private ScannerCoreExtensionsInstallerTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ScannerCoreExtensionsInstallerTest();
        }

        @java.lang.Override
        public ScannerCoreExtensionsInstallerTest implementation() {

...
public class LogCallbackAppenderTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_testLevelTranslation() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testLevelTranslation, this.description("testLevelTranslation"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_testChangeTarget() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testChangeTarget, this.description("testChangeTarget"));
        }
        ...
        private LogCallbackAppenderTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new LogCallbackAppenderTest();
        }

        @java.lang.Override
        public LogCallbackAppenderTest implementation() {

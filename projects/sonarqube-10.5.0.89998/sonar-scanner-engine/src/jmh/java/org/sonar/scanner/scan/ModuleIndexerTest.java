...
public class ModuleIndexerTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_testIndex() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testIndex, this.description("testIndex"));
        }

        private ModuleIndexerTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ModuleIndexerTest();
        }

        @java.lang.Override
        public ModuleIndexerTest implementation() {

...
public class MutableFileSystemTest {
    ...
    private void addFile(InputFile.Status status) {
        underTest.add(new TestInputFileBuilder("foo", String.format("src/%s", generateFilename(status))).setLanguage(LANGUAGE).setStatus(status).build());
    }
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_return_all_files_when_not_restricted() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::return_all_files_when_not_restricted, this.description("return_all_files_when_not_restricted"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_return_only_changed_files_when_restricted() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::return_only_changed_files_when_restricted, this.description("return_only_changed_files_when_restricted"));
        }
        ...
        private MutableFileSystemTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new MutableFileSystemTest();
        }

        @java.lang.Override
        public MutableFileSystemTest implementation() {

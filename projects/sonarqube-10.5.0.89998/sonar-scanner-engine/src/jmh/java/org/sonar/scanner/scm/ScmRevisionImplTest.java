...
public class ScmRevisionImplTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_test_priority_of_revision_sources() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::test_priority_of_revision_sources, this.description("test_priority_of_revision_sources"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_test_empty_values() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::test_empty_values, this.description("test_empty_values"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_ignore_failure_if_scm_does_not_support_revisions() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::ignore_failure_if_scm_does_not_support_revisions, this.description("ignore_failure_if_scm_does_not_support_revisions"));
        }

        private ScmRevisionImplTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ScmRevisionImplTest();
        }

        @java.lang.Override
        public ScmRevisionImplTest implementation() {

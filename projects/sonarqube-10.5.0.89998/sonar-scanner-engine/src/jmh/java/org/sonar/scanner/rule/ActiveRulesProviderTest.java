...
public class ActiveRulesProviderTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_testCombinationOfRules() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testCombinationOfRules, this.description("testCombinationOfRules"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_testParamsAreTransformed() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testParamsAreTransformed, this.description("testParamsAreTransformed"));
        }

        private ActiveRulesProviderTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ActiveRulesProviderTest();
        }

        @java.lang.Override
        public ActiveRulesProviderTest implementation() {

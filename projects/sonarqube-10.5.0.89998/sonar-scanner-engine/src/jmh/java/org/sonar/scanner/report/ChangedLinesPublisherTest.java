...
public class ChangedLinesPublisherTest {
    ...
    public void write_changed_files() {
        ...
        when(provider.branchChangedLines(TARGET_BRANCH, BASE_DIR, paths)).thenReturn(ImmutableMap.of(BASE_DIR.resolve("path1"), lines, BASE_DIR.resolve("path3"), Collections.emptySet()));
    ...
    public void write_changed_file_with_GitScmProvider() {
        ...
        when(scmConfiguration.provider()).thenReturn(provider);
        Set<Integer> lines = new HashSet<>(Arrays.asList(1, 10));
        when(provider.branchChangedLines(eq(TARGET_BRANCH), eq(BASE_DIR), anySet())).thenReturn(ImmutableMap.of(BASE_DIR.resolve("path1"), lines, BASE_DIR.resolve("path3"), Collections.emptySet()));
        publisher.publish(writer);
    ...
    private DefaultInputFile createInputFile(String path, String contents) {
        return new TestInputFileBuilder("module", path).setContents(contents).setProjectBaseDir(BASE_DIR).setModuleBaseDir(BASE_DIR).build();
    }
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_skip_if_scm_is_disabled() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::skip_if_scm_is_disabled, this.description("skip_if_scm_is_disabled"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_skip_if_not_pr() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::skip_if_not_pr, this.description("skip_if_not_pr"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_skip_if_target_branch_is_null() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::skip_if_target_branch_is_null, this.description("skip_if_target_branch_is_null"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_skip_if_no_scm_provider() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::skip_if_no_scm_provider, this.description("skip_if_no_scm_provider"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_skip_if_scm_provider_returns_null() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::skip_if_scm_provider_returns_null, this.description("skip_if_scm_provider_returns_null"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_write_changed_files() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::write_changed_files, this.description("write_changed_files"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_write_changed_file_with_GitScmProvider() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::write_changed_file_with_GitScmProvider, this.description("write_changed_file_with_GitScmProvider"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_write_last_line_as_changed_if_all_other_lines_are_changed_and_last_line_is_empty() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::write_last_line_as_changed_if_all_other_lines_are_changed_and_last_line_is_empty, this.description("write_last_line_as_changed_if_all_other_lines_are_changed_and_last_line_is_empty"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_do_not_write_last_line_as_changed_if_its_not_empty() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::do_not_write_last_line_as_changed_if_its_not_empty, this.description("do_not_write_last_line_as_changed_if_its_not_empty"));
        }
        ...
        private ChangedLinesPublisherTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ChangedLinesPublisherTest();
        }

        @java.lang.Override
        public ChangedLinesPublisherTest implementation() {

...
public class IssueExclusionPatternInitializerTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_testNoConfiguration() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testNoConfiguration, this.description("testNoConfiguration"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldLogInvalidResourceKey() throws java.lang.Throwable {
            this.createImplementation();
            this.runExceptionBenchmark(this.implementation()::shouldLogInvalidResourceKey, this.description("shouldLogInvalidResourceKey"), org.sonar.api.utils.MessageException.class);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldLogInvalidRuleKey() throws java.lang.Throwable {
            this.createImplementation();
            this.runExceptionBenchmark(this.implementation()::shouldLogInvalidRuleKey, this.description("shouldLogInvalidRuleKey"), org.sonar.api.utils.MessageException.class);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldReturnBlockPattern() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldReturnBlockPattern, this.description("shouldReturnBlockPattern"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldLogInvalidStartBlockPattern() throws java.lang.Throwable {
            this.createImplementation();
            this.runExceptionBenchmark(this.implementation()::shouldLogInvalidStartBlockPattern, this.description("shouldLogInvalidStartBlockPattern"), org.sonar.api.utils.MessageException.class);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldReturnAllFilePattern() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldReturnAllFilePattern, this.description("shouldReturnAllFilePattern"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldLogInvalidAllFilePattern() throws java.lang.Throwable {
            this.createImplementation();
            this.runExceptionBenchmark(this.implementation()::shouldLogInvalidAllFilePattern, this.description("shouldLogInvalidAllFilePattern"), org.sonar.api.utils.MessageException.class);
        }
        ...
        private IssueExclusionPatternInitializerTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new IssueExclusionPatternInitializerTest();
        }

        @java.lang.Override
        public IssueExclusionPatternInitializerTest implementation() {

...
public class AnalysisContextReportPublisherTest {
    ...
    public void dumpServerSideGlobalProps() throws Exception {
        ...
        assertThat(content).containsOnlyOnce(COM_FOO).containsOnlyOnce(SONAR_SKIP);
    }
    ...
    public void dumpServerSideProjectProps() throws Exception {
        ...
        assertThat(lines).containsExactly("Plugins:", "Bundled analyzers:", "Global server settings:", "Project server settings:", "  - com.foo=bar", "  - sonar.skip=true", "Project scanner properties:", "  - sonar.projectKey=foo");
    }
    ...
    public void shouldShortenModuleProperties() throws Exception {
        ...
        publisher.init(writer);
        assertThat(writer.getFileStructure().analysisLog()).exists();
        assertThat(FileUtils.readFileToString(writer.getFileStructure().analysisLog(), StandardCharsets.UTF_8)).containsSubsequence("sonar.aVeryLongProp=" + StringUtils.repeat("abcde", 199) + "ab...", "sonar.projectBaseDir=" + baseDir, "sonar.projectKey=foo");
    }
    ...
    public void dontDumpParentProps() throws Exception {
        logTester.setLevel(LoggerLevel.DEBUG);
        DefaultInputModule module = new DefaultInputModule(ProjectDefinition.create().setBaseDir(temp.newFolder()).setWorkDir(temp.newFolder()).setProperty("sonar.projectKey", "foo").setProperty(SONAR_SKIP, "true"));
        DefaultInputModule parent = new DefaultInputModule(ProjectDefinition.create().setBaseDir(temp.newFolder()).setWorkDir(temp.newFolder()).setProperty("sonar.projectKey", "parent").setProperty(SONAR_SKIP, "true"));
        ...
        publisher.init(writer);
        List<String> lines = FileUtils.readLines(writer.getFileStructure().analysisLog(), StandardCharsets.UTF_8);
        assertThat(lines).containsExactly("Plugins:", "Bundled analyzers:", "Global server settings:", "Project server settings:", "Project scanner properties:", "  - sonar.projectKey=parent", "  - sonar.skip=true", "Scanner properties of module: foo", "  - sonar.projectKey=foo");
    }
    ...
    public void init_splitsPluginsByTypeInTheFile() throws IOException {
        ...
        assertThat(lines).contains("Plugins:", "  - Xoo 1.0 (xoo)", "Bundled analyzers:", "  - Java 9.7 (java)");
    }
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_shouldOnlyDumpPluginsByDefault() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldOnlyDumpPluginsByDefault, this.description("shouldOnlyDumpPluginsByDefault"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_dumpServerSideGlobalProps() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::dumpServerSideGlobalProps, this.description("dumpServerSideGlobalProps"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_dumpServerSideProjectProps() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::dumpServerSideProjectProps, this.description("dumpServerSideProjectProps"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldNotDumpSensitiveModuleProperties() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldNotDumpSensitiveModuleProperties, this.description("shouldNotDumpSensitiveModuleProperties"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldShortenModuleProperties() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldShortenModuleProperties, this.description("shouldShortenModuleProperties"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldNotDumpSensitiveGlobalProperties() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldNotDumpSensitiveGlobalProperties, this.description("shouldNotDumpSensitiveGlobalProperties"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_dontDumpParentProps() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::dontDumpParentProps, this.description("dontDumpParentProps"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_init_splitsPluginsByTypeInTheFile() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::init_splitsPluginsByTypeInTheFile, this.description("init_splitsPluginsByTypeInTheFile"));
        }
        ...
        private AnalysisContextReportPublisherTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new AnalysisContextReportPublisherTest();
        }

        @java.lang.Override
        public AnalysisContextReportPublisherTest implementation() {

...
public class CodeMagicTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_isDetected_givenBuildID_detectCodeMagic() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::isDetected_givenBuildID_detectCodeMagic, this.description("isDetected_givenBuildID_detectCodeMagic"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_isDetected_givenNoEnvVariable_dontDetectCodeMagic() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::isDetected_givenNoEnvVariable_dontDetectCodeMagic, this.description("isDetected_givenNoEnvVariable_dontDetectCodeMagic"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_loadConfiguration_commitEnvVariableAvailable_addScmRevisionToConfig() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::loadConfiguration_commitEnvVariableAvailable_addScmRevisionToConfig, this.description("loadConfiguration_commitEnvVariableAvailable_addScmRevisionToConfig"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_loadConfiguration_commitEnvVariableNotAvailable_addScmRevisionToConfig() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::loadConfiguration_commitEnvVariableNotAvailable_addScmRevisionToConfig, this.description("loadConfiguration_commitEnvVariableNotAvailable_addScmRevisionToConfig"));
        }
        ...
        private CodeMagicTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new CodeMagicTest();
        }

        @java.lang.Override
        public CodeMagicTest implementation() {

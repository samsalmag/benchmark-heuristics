...
public class ModuleSensorsExecutorTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_should_not_execute_global_sensor_for_submodule() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_not_execute_global_sensor_for_submodule, this.description("should_not_execute_global_sensor_for_submodule"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_execute_all_sensors_for_root_module() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_execute_all_sensors_for_root_module, this.description("should_execute_all_sensors_for_root_module"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_not_restrict_filesystem_when_pull_request_and_non_expected_sensor() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_not_restrict_filesystem_when_pull_request_and_non_expected_sensor, this.description("should_not_restrict_filesystem_when_pull_request_and_non_expected_sensor"));
        }
        ...
        private ModuleSensorsExecutorTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ModuleSensorsExecutorTest();
        }

        @java.lang.Override
        public ModuleSensorsExecutorTest implementation() {

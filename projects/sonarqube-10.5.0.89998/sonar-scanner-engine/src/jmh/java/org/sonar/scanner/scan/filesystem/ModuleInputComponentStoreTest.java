...
public class ModuleInputComponentStoreTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_should_cache_files_by_filename() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_cache_files_by_filename, this.description("should_cache_files_by_filename"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_cache_files_by_extension() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_cache_files_by_extension, this.description("should_cache_files_by_extension"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_not_cache_duplicates() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_not_cache_duplicates, this.description("should_not_cache_duplicates"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_get_empty_iterable_on_cache_miss() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_get_empty_iterable_on_cache_miss, this.description("should_get_empty_iterable_on_cache_miss"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_find_module_components_with_non_global_strategy() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_find_module_components_with_non_global_strategy, this.description("should_find_module_components_with_non_global_strategy"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_find_all_components_with_global_strategy() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_find_all_components_with_global_strategy, this.description("should_find_all_components_with_global_strategy"));
        }
        ...
        private ModuleInputComponentStoreTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ModuleInputComponentStoreTest();
        }

        @java.lang.Override
        public ModuleInputComponentStoreTest implementation() {

...
public class DefaultServerTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_shouldLoadServerProperties() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldLoadServerProperties, this.description("shouldLoadServerProperties"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_publicRootUrl() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::publicRootUrl, this.description("publicRootUrl"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_invalid_startup_date_throws_exception() throws java.lang.Throwable {
            this.createImplementation();
            this.runExceptionBenchmark(this.implementation()::invalid_startup_date_throws_exception, this.description("invalid_startup_date_throws_exception"), java.lang.RuntimeException.class);
        }

        private DefaultServerTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new DefaultServerTest();
        }

        @java.lang.Override
        public DefaultServerTest implementation() {

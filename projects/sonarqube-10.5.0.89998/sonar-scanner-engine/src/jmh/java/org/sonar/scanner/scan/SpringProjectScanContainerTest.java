...
public class SpringProjectScanContainerTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_should_add_only_batch_extensions() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_add_only_batch_extensions, this.description("should_add_only_batch_extensions"));
        }

        private SpringProjectScanContainerTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SpringProjectScanContainerTest();
        }

        @java.lang.Override
        public SpringProjectScanContainerTest implementation() {

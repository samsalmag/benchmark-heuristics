...
public class DefaultNewCodePeriodLoaderTest {
    ...
    private InputStream createResponse(NewCodePeriods.NewCodePeriodType type, String value) throws IOException {
        ...
        NewCodePeriods.ShowWSResponse response = NewCodePeriods.ShowWSResponse.newBuilder().setType(type).setValue(value).build();
        response.writeTo(os);
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_loads_new_code_period() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::loads_new_code_period, this.description("loads_new_code_period"));
        }

        private DefaultNewCodePeriodLoaderTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new DefaultNewCodePeriodLoaderTest();
        }

        @java.lang.Override
        public DefaultNewCodePeriodLoaderTest implementation() {

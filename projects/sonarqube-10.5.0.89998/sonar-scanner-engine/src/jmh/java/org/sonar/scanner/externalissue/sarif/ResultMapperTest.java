...
public class ResultMapperTest {
    ...
    public void mapResult_ifRuleIdMissing_fails() {
        ...
        assertThatNullPointerException().isThrownBy(() -> resultMapper.mapResult(DRIVER_NAME, WARNING, WARNING, result)).withMessage("No ruleId found for issue thrown by driver driverName");
    }
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_mapResult_mapsSimpleFieldsCorrectly() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::mapResult_mapsSimpleFieldsCorrectly, this.description("mapResult_mapsSimpleFieldsCorrectly"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_mapResult_ifRuleIdMissing_fails() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::mapResult_ifRuleIdMissing_fails, this.description("mapResult_ifRuleIdMissing_fails"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_mapResult_whenLocationExists_createsFileLocation() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::mapResult_whenLocationExists_createsFileLocation, this.description("mapResult_whenLocationExists_createsFileLocation"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_mapResult_whenLocationExistsButLocationMapperReturnsNull_createsProjectLocation() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::mapResult_whenLocationExistsButLocationMapperReturnsNull_createsProjectLocation, this.description("mapResult_whenLocationExistsButLocationMapperReturnsNull_createsProjectLocation"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_mapResult_whenLocationsIsEmpty_createsProjectLocation() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::mapResult_whenLocationsIsEmpty_createsProjectLocation, this.description("mapResult_whenLocationsIsEmpty_createsProjectLocation"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_mapResult_whenLocationsIsNull_createsProjectLocation() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::mapResult_whenLocationsIsNull_createsProjectLocation, this.description("mapResult_whenLocationsIsNull_createsProjectLocation"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_mapResult_mapsCorrectlyCleanCodeAttribute() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::mapResult_mapsCorrectlyCleanCodeAttribute, this.description("mapResult_mapsCorrectlyCleanCodeAttribute"));
        }
        ...
        private ResultMapperTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ResultMapperTest();
        }

        @java.lang.Override
        public ResultMapperTest implementation() {

...
public class DefaultLanguagesRepositoryTest {
    ...
    public void should_load_languages_from_ws() {
        WsTestUtil.mockReader(wsClient, "/api/languages/list", new InputStreamReader(getClass().getResourceAsStream("DefaultLanguageRepositoryTest/languages-ws.json")));
    ...
    public void get_find_language_by_key() {
        ...
        when(properties.getStringArray("sonar.java.file.suffixes")).thenReturn(JAVA_SUFFIXES);
        underTest.start();
        assertThat(underTest.get("java")).extracting("key", "name", "fileSuffixes", "publishAllFiles").containsOnly("java", "Java", JAVA_SUFFIXES, true);
    }
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_should_load_languages_from_ws() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_load_languages_from_ws, this.description("should_load_languages_from_ws"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_throw_error_on_invalid_ws_response() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_throw_error_on_invalid_ws_response, this.description("should_throw_error_on_invalid_ws_response"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_return_null_when_language_not_found() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_return_null_when_language_not_found, this.description("should_return_null_when_language_not_found"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_publishAllFiles_by_default() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::publishAllFiles_by_default, this.description("publishAllFiles_by_default"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_get_find_language_by_key() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::get_find_language_by_key, this.description("get_find_language_by_key"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_log_if_language_has_no_suffixes_or_patterns() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_log_if_language_has_no_suffixes_or_patterns, this.description("should_log_if_language_has_no_suffixes_or_patterns"));
        }
        ...
        private DefaultLanguagesRepositoryTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new DefaultLanguagesRepositoryTest();
        }

        @java.lang.Override
        public DefaultLanguagesRepositoryTest implementation() {

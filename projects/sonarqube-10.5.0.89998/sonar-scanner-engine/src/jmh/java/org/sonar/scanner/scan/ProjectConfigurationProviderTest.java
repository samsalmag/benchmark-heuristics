...
public class ProjectConfigurationProviderTest {
    ...
    private static final Map<String, String> ALL_PROPERTIES_MAP = Stream.of(GLOBAL_SERVER_PROPERTIES, PROJECT_SERVER_PROPERTIES, DEFAULT_PROJECT_PROPERTIES).flatMap(map -> map.entrySet().stream()).collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue));
    ...
    public void should_concatAllPropertiesForCallFilterAndApplyFilterChanges() {
        ...
        when(sonarGlobalPropertiesFilter.enforceOnlyServerSideSonarGlobalPropertiesAreUsed(ALL_PROPERTIES_MAP, GLOBAL_SERVER_PROPERTIES)).thenReturn(PROPERTIES_AFTER_FILTERING);
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_should_concatAllPropertiesForCallFilterAndApplyFilterChanges() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_concatAllPropertiesForCallFilterAndApplyFilterChanges, this.description("should_concatAllPropertiesForCallFilterAndApplyFilterChanges"));
        }
        ...
        private ProjectConfigurationProviderTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ProjectConfigurationProviderTest();
        }

        @java.lang.Override
        public ProjectConfigurationProviderTest implementation() {

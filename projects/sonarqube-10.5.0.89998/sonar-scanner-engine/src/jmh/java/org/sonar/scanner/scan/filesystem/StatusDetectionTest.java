...
public class StatusDetectionTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_detect_status() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::detect_status, this.description("detect_status"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_detect_status_branches_exclude() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::detect_status_branches_exclude, this.description("detect_status_branches_exclude"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_detect_status_branches_confirm() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::detect_status_branches_confirm, this.description("detect_status_branches_confirm"));
        }

        private StatusDetectionTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new StatusDetectionTest();
        }

        @java.lang.Override
        public StatusDetectionTest implementation() {

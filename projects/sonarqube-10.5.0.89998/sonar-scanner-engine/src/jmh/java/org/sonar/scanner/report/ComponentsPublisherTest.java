...
public class ComponentsPublisherTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_add_components_to_report() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::add_components_to_report, this.description("add_components_to_report"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_publish_unchanged_components_even_in_prs() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::publish_unchanged_components_even_in_prs, this.description("publish_unchanged_components_even_in_prs"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_publish_project_without_version_and_name() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::publish_project_without_version_and_name, this.description("publish_project_without_version_and_name"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_publish_project_with_links() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::publish_project_with_links, this.description("publish_project_with_links"));
        }
        ...
        private ComponentsPublisherTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ComponentsPublisherTest();
        }

        @java.lang.Override
        public ComponentsPublisherTest implementation() {

...
public class AbstractExclusionFiltersTest {
    ...
    public void should_handleAliasForTestInclusionsProperty() {
        ...
        String expectedWarn = "Use of sonar.tests.inclusions detected. " + "While being taken into account, the only supported property is sonar.test.inclusions. Consider updating your configuration.";
        assertThat(logTester.logs(Level.WARN)).hasSize(1).contains(expectedWarn);
    ...
    public void should_handleAliasForTestExclusionsProperty() {
        ...
        String expectedWarn = "Use of sonar.tests.exclusions detected. " + "While being taken into account, the only supported property is sonar.test.exclusions. Consider updating your configuration.";
        assertThat(logTester.logs(Level.WARN)).hasSize(1).contains(expectedWarn);
        verify(analysisWarnings).addUnique(expectedWarn);
    }
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_should_handleAliasForTestInclusionsProperty() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_handleAliasForTestInclusionsProperty, this.description("should_handleAliasForTestInclusionsProperty"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_handleAliasForTestExclusionsProperty() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_handleAliasForTestExclusionsProperty, this.description("should_handleAliasForTestExclusionsProperty"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_AbstractExclusionFilters_whenUsedGlobalTestPropertyAndProjectTestLegacyProperty_shouldNotLogAliasWarning() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::AbstractExclusionFilters_whenUsedGlobalTestPropertyAndProjectTestLegacyProperty_shouldNotLogAliasWarning, this.description("AbstractExclusionFilters_whenUsedGlobalTestPropertyAndProjectTestLegacyProperty_shouldNotLogAliasWarning"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_keepLegacyValue_when_legacyAndAliasPropertiesAreUsedForTestInclusions() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_keepLegacyValue_when_legacyAndAliasPropertiesAreUsedForTestInclusions, this.description("should_keepLegacyValue_when_legacyAndAliasPropertiesAreUsedForTestInclusions"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_keepLegacyValue_when_legacyAndAliasPropertiesAreUsedForTestExclusions() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_keepLegacyValue_when_legacyAndAliasPropertiesAreUsedForTestExclusions, this.description("should_keepLegacyValue_when_legacyAndAliasPropertiesAreUsedForTestExclusions"));
        }
        ...
        private AbstractExclusionFiltersTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new AbstractExclusionFiltersTest();
        }

        @java.lang.Override
        public AbstractExclusionFiltersTest implementation() {

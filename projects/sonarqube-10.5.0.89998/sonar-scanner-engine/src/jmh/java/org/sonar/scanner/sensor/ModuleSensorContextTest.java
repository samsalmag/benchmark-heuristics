...
public class ModuleSensorContextTest {
    ...
    public void prepare() throws Exception {
        ...
        underTest = new ModuleSensorContext(mock(DefaultInputProject.class), mock(InputModule.class), settings.asConfig(), settings, fs, activeRules, sensorStorage, runtime, branchConfiguration, writeCache, readCache, analysisCacheEnabled, unchangedFilesHandler);
    }
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_shouldProvideComponents_returnsNotNull() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldProvideComponents_returnsNotNull, this.description("shouldProvideComponents_returnsNotNull"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_delegate_to_unchanged_files_handler() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_delegate_to_unchanged_files_handler, this.description("should_delegate_to_unchanged_files_handler"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_pull_request_can_skip_unchanged_files() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::pull_request_can_skip_unchanged_files, this.description("pull_request_can_skip_unchanged_files"));
        }
        ...
        private ModuleSensorContextTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ModuleSensorContextTest();
        }

        @java.lang.Override
        public ModuleSensorContextTest implementation() {

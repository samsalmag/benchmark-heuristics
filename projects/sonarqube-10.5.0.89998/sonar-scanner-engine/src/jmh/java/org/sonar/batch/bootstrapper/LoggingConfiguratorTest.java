...
public class LoggingConfiguratorTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_testWithFile() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testWithFile, this.description("testWithFile"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_testCustomAppender() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testCustomAppender, this.description("testCustomAppender"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_testNoStdout() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testNoStdout, this.description("testNoStdout"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_testConfigureMultipleTimes() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testConfigureMultipleTimes, this.description("testConfigureMultipleTimes"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_testFormatNoEffect() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testFormatNoEffect, this.description("testFormatNoEffect"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_testNoListener() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::testNoListener, this.description("testNoListener"));
        }
        ...
        public org.junit.runners.model.Statement applyRuleFields(org.junit.runners.model.Statement statement, org.junit.runner.Description description) {
            statement = this.applyRule(this.implementation().folder, statement, description);
            statement = super.applyRuleFields(statement, description);
            return statement;
        }

        private LoggingConfiguratorTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new LoggingConfiguratorTest();
        }

        @java.lang.Override
        public LoggingConfiguratorTest implementation() {

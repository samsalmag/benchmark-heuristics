...
public class InputComponentStoreTest {
    ...
    static class InputComponentStoreTester extends InputComponentStore {
        ...
        InputFile addFile(String moduleKey, String relPath) {
            DefaultInputFile file = new TestInputFileBuilder(moduleKey, relPath).build();
            put(moduleKey, file);
            return file;
        }
    }
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_should_add_input_file() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_add_input_file, this.description("should_add_input_file"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_add_languages_per_module_and_globally() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_add_languages_per_module_and_globally, this.description("should_add_languages_per_module_and_globally"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_should_find_files_per_module_and_globally() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::should_find_files_per_module_and_globally, this.description("should_find_files_per_module_and_globally"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_stores_not_analysed_c_file_count_in_sq_community_edition() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::stores_not_analysed_c_file_count_in_sq_community_edition, this.description("stores_not_analysed_c_file_count_in_sq_community_edition"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_stores_not_analysed_cpp_file_count_in_sq_community_edition() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::stores_not_analysed_cpp_file_count_in_sq_community_edition, this.description("stores_not_analysed_cpp_file_count_in_sq_community_edition"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_does_not_store_not_analysed_file_counts_in_sq_non_community_editions() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::does_not_store_not_analysed_file_counts_in_sq_non_community_editions, this.description("does_not_store_not_analysed_file_counts_in_sq_non_community_editions"));
        }
        ...
        public org.junit.runners.model.Statement applyClassRuleFields(org.junit.runners.model.Statement statement, org.junit.runner.Description description) {
            statement = this.applyRule(InputComponentStoreTest.temp, statement, description);
            statement = super.applyClassRuleFields(statement, description);
            return statement;
        }

        private InputComponentStoreTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new InputComponentStoreTest();
        }

        @java.lang.Override
        public InputComponentStoreTest implementation() {

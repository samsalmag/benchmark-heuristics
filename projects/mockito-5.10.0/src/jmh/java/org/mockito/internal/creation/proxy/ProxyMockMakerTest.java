...
public class ProxyMockMakerTest extends AbstractMockMakerTest<ProxyMockMaker, ProxyMockMakerTest.SomeInterface> {
    ...
    public void should_create_mock_from_interface_with_extra_interface() {
        SomeInterface proxy = mockMaker.createMock(settingsFor(SomeInterface.class, Serializable.class), dummyHandler());
        Class<?> superClass = proxy.getClass().getSuperclass();
        assertThat(superClass).isEqualTo(Proxy.class);
    ...
    public void should_discover_mockable_input() {
        ...
        assertThat(mockMaker.isTypeMockable(Number.class).nonMockableReason()).isEqualTo("non-interface");
    ...
    public void can_compute_hash_code() throws Throwable {
        ...
        assertThat(handler.invoke(proxy, Object.class.getMethod("hashCode"), null)).isEqualTo(System.identityHashCode(proxy));
    }
    ...
    public void can_compute_equality() throws Throwable {
        SomeInterface proxy = mockMaker.createMock(settingsFor(SomeInterface.class), dummyHandler());
        InvocationHandler handler = Proxy.getInvocationHandler(proxy);
        assertThat(handler.invoke(proxy, Object.class.getMethod("equals", Object.class), new Object[] { proxy })).isEqualTo(true);
        assertThat(handler.invoke(proxy, Object.class.getMethod("equals", Object.class), new Object[] { null })).isEqualTo(false);
        assertThat(handler.invoke(proxy, Object.class.getMethod("equals", Object.class), new Object[] { new Object() })).isEqualTo(false);
    }

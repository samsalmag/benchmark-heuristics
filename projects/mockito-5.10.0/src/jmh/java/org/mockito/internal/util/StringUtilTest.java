...
public class StringUtilTest {
    ...
    public void decamelizes_matcher_name() throws Exception {
        assertEquals("<Sentence with strong language>", StringUtil.decamelizeMatcherName("SentenceWithStrongLanguage"));
        assertEquals("<W e i r d o 1>", StringUtil.decamelizeMatcherName("WEIRDO1"));
        assertEquals("<_>", StringUtil.decamelizeMatcherName("_"));
        assertEquals("<Has exactly 3 elements>", StringUtil.decamelizeMatcherName("HasExactly3Elements"));

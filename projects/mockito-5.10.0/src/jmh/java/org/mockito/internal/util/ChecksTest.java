...
public class ChecksTest {
    ...
    public void checkNotNull_null() {
        ...
        }).isInstanceOf(IllegalArgumentException.class).hasMessageContaining("someValue should not be null");
    }
    ...
    public void checkNotNull_null_additonal_message() {
        ...
        }).isInstanceOf(IllegalArgumentException.class).hasMessageContaining("someValue should not be null. Oh no!");
    }
}

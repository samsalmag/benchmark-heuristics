...
public class ReporterTest extends TestBase {
    ...
    public void should_let_passing_null_last_actual_stack_trace() {
        ...
        }).isInstanceOf(TooFewActualInvocations.class).hasMessageContainingAll("iMethods.simpleMethod();", "Wanted 1 time:", "But was 2 times:");
    }
    ...
    public void should_throw_correct_exception_for_null_invocation_listener() {
        ...
        }).isInstanceOf(MockitoException.class).hasMessage("invocationListeners() does not accept null vararg array See the Javadoc.");
    }
    ...
    public void can_use_mock_name_even_when_mock_bogus_default_answer_and_when_reporting_no_more_interaction_wanted() {
        ...
        }).isInstanceOf(NoInteractionsWanted.class).hasMessageContainingAll("No interactions wanted here:", "But found this interaction on mock 'iMethods':");
    }
    ...
    public void can_use_print_mock_name_even_when_mock_bogus_default_answer_and_when_reporting_no_more_interaction_wanted_in_order() {
        ...
        }).isInstanceOf(VerificationInOrderFailure.class).hasMessageContainingAll("No interactions wanted here:", "But found this interaction on mock 'iMethods':");
    }
    ...
    public void can_use_print_mock_name_even_when_mock_bogus_default_answer_and_when_reporting_injection_failure() {
        ...
        }).isInstanceOf(MockitoException.class).hasMessageContainingAll("Mockito couldn't inject mock dependency 'iMethods' on field", "'static final org.mockito.internal.MockitoCore org.mockito.Mockito.MOCKITO_CORE'", "whose type 'org.mockito.Mockito' was annotated by @InjectMocks in your test.", "Also I failed because: null");
    }

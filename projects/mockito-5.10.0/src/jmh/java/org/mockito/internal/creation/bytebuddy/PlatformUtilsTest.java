...
class PlatformUtilsTest {
    ...
    @CsvSource(value = { "java.specification.vendor, expected result", "                  android,            true", "                  AnDrOId,            true", "             anythingElse,           false", "                         ,           false" }, useHeadersInDisplayName = true)
    @ParameterizedTest

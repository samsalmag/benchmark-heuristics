...
public class MatcherToStringTest extends TestBase {
    ...
    public void default_name_for_anonymous_matchers() {
        ArgumentMatcher<Object> anonymousMatcher = new ArgumentMatcher<Object>() {
        ...
        ArgumentMatcher<Object> anonymousDescriptiveMatcher = new MatcherWithDescription() {
        ...
        assertEquals("*my custom description*", MatcherToString.toString(anonymousDescriptiveMatcher));
    }

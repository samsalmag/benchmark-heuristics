...
public class FieldInitializerTest {
    ...
    public void should_fail_to_instantiate_field_if_no_default_constructor() throws Exception {
        ...
        }).isInstanceOf(MockitoException.class).hasMessage("the type 'StaticClassWithoutDefaultConstructor' has no default constructor");
    }
    ...
    public void should_fail_for_abstract_field() {
        ...
        }).isInstanceOf(MockitoException.class).hasMessage("the type 'AbstractStaticClass' is an abstract class.");
    }
    ...
    public void should_fail_for_interface_field() {
        ...
        }).isInstanceOf(MockitoException.class).hasMessage("the type 'Interface' is an interface.");
    }
    ...
    public void should_fail_for_local_type_field() {
        ...
        }).isInstanceOf(MockitoException.class).hasMessage("the type 'LocalType' is a local class.");
    }
    ...
    public void should_fail_for_inner_class_field() {
        ...
        }).isInstanceOf(MockitoException.class).hasMessage("the type 'InnerClassType' is an inner non static class.");
    }

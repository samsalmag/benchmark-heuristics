...
public class MockNameImplTest extends TestBase {
    ...
    public void shouldProvideTheNameForAnonymousClass() throws Exception {
        ...
        // when
        String name = new MockNameImpl(null, anonymousInstance.getClass(), MockType.INSTANCE).toString();
        // then
    ...
    public void shouldProvideTheNameForAnonymousClassOnStatic() throws Exception {
        ...
        // when
        String name = new MockNameImpl(null, anonymousInstance.getClass(), MockType.STATIC).toString();
        // then

...
public class EqualsBuilderTest extends TestBase {
    ...
    private void testReflectionHierarchyEquals(boolean testTransients) {
        ...
        assertTrue(EqualsBuilder.reflectionEquals(to1, ttso, // Force testTransients = false for this assert
        false));
        assertTrue(EqualsBuilder.reflectionEquals(ttso, to1, // Force testTransients = false for this assert
        false));
        assertTrue(EqualsBuilder.reflectionEquals(to1, tttso, // Force testTransients = false for this assert
        false));
        assertTrue(EqualsBuilder.reflectionEquals(tttso, to1, // Force testTransients = false for this assert
        false));
        assertTrue(EqualsBuilder.reflectionEquals(ttso, tttso, // Force testTransients = false for this assert
        false));
        assertTrue(EqualsBuilder.reflectionEquals(tttso, ttso, // Force testTransients = false for this assert
        false));

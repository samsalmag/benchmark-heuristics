...
public class ReturnsSmartNullsTest extends TestBase {
    ...
    private static <T> InterceptedInvocation invocationMethodWithArgs(final T obj) throws NoSuchMethodException {
        return new InterceptedInvocation(new MockStrongReference<Object>(mock(GenericFooBar.class), false), new SerializableMethod(GenericFooBar.class.getMethod("methodWithArgs", int.class, Object.class)), new Object[] { 1, obj }, InterceptedInvocation.NO_OP, LocationFactory.create(), 1);
    }
    ...
    public void should_return_a_empty_set_that_has_been_defined_with_method_generic_and_provided_in_argument() throws Throwable {
        Answer<Object> answer = new ReturnsSmartNulls();
        Object smartNull = answer.answer(invocationMethodWithArgs(new HashSet<String>(Arrays.asList("set-1", "set-2"))));
    ...
    private static <T> InterceptedInvocation invocationMethodWithVarArgs(final T[] obj) throws NoSuchMethodException {
        return new InterceptedInvocation(new MockStrongReference<Object>(mock(GenericFooBar.class), false), new SerializableMethod(GenericFooBar.class.getMethod("methodWithVarArgs", int.class, Object[].class)), new Object[] { 1, obj }, InterceptedInvocation.NO_OP, LocationFactory.create(), 1);
    }

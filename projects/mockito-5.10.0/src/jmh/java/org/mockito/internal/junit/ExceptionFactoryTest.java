...
public class ExceptionFactoryTest {
    ...
    private static final ClassLoader classLoaderWithoutJUnitOrOpenTest = excludingClassLoader().withCodeSourceUrlOf(ExceptionFactory.class).without("org.junit", "junit", "org.opentest4j").build();

    private static final ClassLoader currentClassLoader = ExceptionFactoryTest.class.getClassLoader();

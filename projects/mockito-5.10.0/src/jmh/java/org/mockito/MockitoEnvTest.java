...
public class MockitoEnvTest {
    ...
    public void uses_default_mock_maker_from_env() {
        ...
        assertThat(DefaultMockitoPlugins.getDefaultPluginClass(MockMaker.class.getName())).isEqualTo(Plugins.getMockMaker().getClass().getName());
    }
    ...
    public void uses_mock_maker_from_env() {
        ...
        assertThat(DefaultMockitoPlugins.getDefaultPluginClass(mockMaker)).isEqualTo(Plugins.getMockMaker().getClass().getName());
    }
    ...
    public void uses_default_member_accessor_from_env() {
        ...
        assertThat(DefaultMockitoPlugins.getDefaultPluginClass(MemberAccessor.class.getName())).isEqualTo(Plugins.getMemberAccessor().getClass().getName());
    }
    ...
    public void uses_member_accessor_from_env() {
        ...
        assertThat(DefaultMockitoPlugins.getDefaultPluginClass(memberAccessor)).isEqualTo(Plugins.getMemberAccessor().getClass().getName());
    }
}

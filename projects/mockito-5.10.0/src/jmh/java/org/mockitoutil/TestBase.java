...
public class TestBase {
    ...
    protected static Invocation invocationOf(Class<?> type, String methodName, Object... args) throws NoSuchMethodException {
        ...
        return new InterceptedInvocation(new MockStrongReference<Object>(mock(type), false), new SerializableMethod(type.getMethod(methodName, types)), args, InterceptedInvocation.NO_OP, LocationFactory.create(), 1);
    }
    ...
    public static abstract class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void after() throws java.lang.Throwable {
            this.implementation().cleanUpConfigInAnyCase();
            super.after();
        }

        private TestBase implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new TestBase();
        }

        @java.lang.Override
        public TestBase implementation() {

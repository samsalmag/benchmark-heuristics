...
public class NPEWithCertainMatchersTest extends TestBase {
    ...
    public void shouldNotThrowNPEWhenNullPassedToEq() {
        ...
        }).isInstanceOf(AssertionError.class).hasMessageContainingAll("Argument(s) are different! Wanted:", "mock.objectArgMethod(null);", "Actual invocations have different arguments:", "mock.objectArgMethod(\"not null\");");
    }
    ...
    public void shouldNotThrowNPEWhenNullPassedToSame() {
        ...
        }).isInstanceOf(AssertionError.class).hasMessageContainingAll("Argument(s) are different! Wanted:", "mock.objectArgMethod(same(null));", "Actual invocations have different arguments:", "mock.objectArgMethod(\"not null\");");
    }
}

...
public class PackagePrivateWithContextClassLoaderTest {
    ...
    public void should_be_able_to_mock_interface_method_package_private_param() throws Exception {
        PublicInterfaceWithPackagePrivateMethodParam publicClass = mock(PublicInterfaceWithPackagePrivateMethodParam.class);
        publicClass.doSomething(null);
    }

    @Test
    public void should_be_able_to_mock_interface_method_package_private_return() throws Exception {
        PublicInterfaceWithPackagePrivateMethodReturn publicClass = mock(PublicInterfaceWithPackagePrivateMethodReturn.class);
        PackagePrivateInterface packagePrivateInterface = publicClass.doSomething();
    }

    @Test
    public void should_be_able_to_mock_interface_method_package_private_return_override() throws Exception {
        PublicInterfaceOverridesPackagePrivateMethodReturn publicClass = mock(PublicInterfaceOverridesPackagePrivateMethodReturn.class);
        PackagePrivateInterface packagePrivateInterface = publicClass.doSomething();
    }
    ...
    public void should_be_able_to_mock_package_private_extra_interface() throws Exception {
        PackagePrivateInterface mock = (PackagePrivateInterface) mock(PublicInterface.class, withSettings().extraInterfaces(PackagePrivateInterface.class));
    }
    ...
    public void classloader_with_parent_but_does_not_delegate() throws Exception {
        ...
        Class<?> loaded = Class.forName(LoadedByCustomLoader.class.getName(), false, nonDelegatingLoader);

...
public class AtLeastMarksAllInvocationsVerified extends TestBase {
    ...
    public void shouldFailBecauseDisallowedMethodWasCalled() {
        ...
        }).isInstanceOf(NoInteractionsWanted.class).hasMessageContainingAll("No interactions wanted here:", "-> at ", "But found this interaction on mock 'someMethods':", "-> at ", "For your reference, here is the list of all invocations ([?] - means unverified).", "1. -> at ", "2. [?]-> at ");
    }
}

...
public class RelaxedVerificationInOrderTest extends TestBase {
    ...
    public void shouldFailVerificationOfNonFirstChunk() {
        ...
        }).isInstanceOf(VerificationInOrderFailure.class).hasMessageContainingAll("Verification in order failure:", "iMethods.simpleMethod(2);", "Wanted 1 time:", "-> at ", "But was 3 times:", "-> at ", "-> at ", "-> at ");
    }
    ...
    public void shouldFailOnWrongMethodCalledOnMockTwo() {
        ...
        }).isInstanceOf(WantedButNotInvoked.class).hasMessageContainingAll("Wanted but not invoked:", "iMethods.differentMethod();", "-> at ", "However, there were exactly 6 interactions with this mock:", "iMethods.simpleMethod(1);", "-> at ", "iMethods.simpleMethod(2);", "-> at ", "iMethods.simpleMethod(2);", "-> at ", "iMethods.simpleMethod(3);", "-> at ", "iMethods.simpleMethod(2);", "-> at ", "iMethods.simpleMethod(4);", "-> at ");
    }
    ...
    public void shouldFailWhenMockTwoWantedZeroTimes() {
        ...
        }).isInstanceOf(VerificationInOrderFailure.class).hasMessageContainingAll("Verification in order failure:", "iMethods.simpleMethod(2);", "Wanted 0 times:", "-> at ", "But was 3 times:", "-> at ", "-> at ", "-> at ");
    }

...
public class VerificationInOrderWithCallsTest extends TestBase {
    ...
    public void shouldFailWhenMethodNotCalled() {
        ...
        }).isInstanceOf(VerificationInOrderFailure.class).hasMessageContainingAll("Verification in order failure", "Wanted but not invoked", "mockOne.oneArg(2)");
    }
    ...
    public void shouldFailWhenMethodCalledTooFewTimes() {
        ...
        }).isInstanceOf(VerificationInOrderFailure.class).hasMessageContainingAll("Verification in order failure", "mockOne.oneArg(2)", "Wanted 2 times", "But was 1 time");
    }
    ...
    public void shouldFailWhenSingleMethodCallsAreOutOfSequence() {
        ...
        assertThatThrownBy(() -> {
            verifier.verify(mockOne, calls(1)).oneArg(1);
        }).isInstanceOf(VerificationInOrderFailure.class).hasMessageContainingAll("Verification in order failure", "Wanted but not invoked", "mockOne.oneArg(1)");
    }
    ...
    public void shouldFailWhenMethodCallsOnDifferentMocksAreOutOfSequence() {
        ...
        assertThatThrownBy(() -> {
            verifier.verify(mockOne, calls(1)).voidMethod();
        }).isInstanceOf(VerificationInOrderFailure.class).hasMessageContainingAll("Verification in order failure", "Wanted but not invoked", "mockOne.voidMethod()");
    }
    ...
    public void shouldNotVerifySkippedCallsInInOrderWhenFewerCallsForSingleMethod() {
        ...
        assertThatThrownBy(() -> {
            verifier.verifyNoMoreInteractions();
        }).isInstanceOf(VerificationInOrderFailure.class).hasMessageContaining("No interactions wanted here");
    }
    ...
    public void shouldFailToCreateCallsWithZeroArgument() {
        ...
        }).isInstanceOf(MockitoException.class).hasMessageContaining("Negative and zero values are not allowed here");
    }
    ...
    public void shouldFailToCreateCallsForNonInOrderVerification() {
        ...
        }).isInstanceOf(MockitoException.class).hasMessageContaining("calls is only intended to work with InOrder");
    }
}

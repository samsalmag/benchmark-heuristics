...
public class StrictnessPerMockTest {
    ...
    public void unnecessary_stubbing() {
        ...
        }).isInstanceOf(UnnecessaryStubbingException.class).hasMessageContaining("1. -> ").// good enough to prove that we're flagging just one unnecessary stubbing:
    ...
    public void verify_no_more_invocations() {
        ...
        }).isInstanceOf(NoInteractionsWanted.class).hasMessageContaining("But found this interaction on mock 'iMethods'").// TODO 792: let's make NoInteractionsWanted exception contain the Invocation
        // instances
        // so that we can write clean assertion rather than depending on string

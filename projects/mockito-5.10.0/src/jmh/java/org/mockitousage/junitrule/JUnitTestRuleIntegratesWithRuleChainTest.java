...
public class JUnitTestRuleIntegratesWithRuleChainTest {
    ...
    public static class LenientByDefault {
        ...
        @Rule
        public final RuleChain chain = RuleChain.outerRule(MockitoJUnit.testRule(this)).around((base, description) -> new Statement() {
    ...
    public static class StrictByDefault {
        ...
        @Rule
        public final RuleChain chain = RuleChain.outerRule(MockitoJUnit.testRule(this).strictness(Strictness.STRICT_STUBS)).around((base, description) -> new Statement() {

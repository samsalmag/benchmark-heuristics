...
public class StrictStubbingEndToEndTest {
    ...
    public void finish_mocking_exception_does_not_hide_the_exception_from_test() {
        ...
        assertThat(result).// both exceptions are reported to JUnit:
        fails("unnecessary_stubbing", IllegalStateException.class).fails("unnecessary_stubbing", UnnecessaryStubbingException.class);
    }

...
public class StubbingWithThrowablesTest extends TestBase {
    ...
    public void throws_new_exception_consecutively_from_class() {
        ...
        NaughtyException first = Assertions.catchThrowableOfType(() -> mock.add(null), NaughtyException.class);
        NaughtyException second = Assertions.catchThrowableOfType(() -> mock.add(null), NaughtyException.class);
    ...
    public void shouldNotAllowSettingInvalidCheckedException() {
        ...
        }).isInstanceOf(MockitoException.class).hasMessageContaining("Checked exception is invalid for this method");
    }
    ...
    private void assertExceptionTypeCanNotBeNull(ThrowingCallable throwingCallable) {
        assertThatThrownBy(throwingCallable).isInstanceOf(MockitoException.class).hasMessageContaining("Exception type cannot be null");
    }
    ...
    public void doThrowShouldNotAllowSettingNullThrowableClass() {
        ...
        }).isInstanceOf(MockitoException.class).hasMessageContaining("Exception type cannot be null");
    }

...
public interface IMethods {
    ...
    String fourArgumentVarArgsMethod(int valueOne, String valueTwo, int valueThree, String... valueFour);

    String fiveArgumentVarArgsMethod(int valueOne, String valueTwo, int valueThree, String valueFour, String... valueFive);

    String sixArgumentVarArgsMethod(int valueOne, String valueTwo, int valueThree, String valueFour, String valueFive, String... valueSix);

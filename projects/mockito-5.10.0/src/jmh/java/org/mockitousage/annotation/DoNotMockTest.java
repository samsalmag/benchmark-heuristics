...
public class DoNotMockTest {
    ...
    public void can_not_statically_mock_class_with_interface_annotated_with_donotmock() {
        assertThatThrownBy(() -> {
            MockedStatic<SubclassOfNotMockableInterface> notMockable = mockStatic(SubclassOfNotMockableInterface.class);
        }).isInstanceOf(DoNotMockException.class);
    }
    ...
    public void can_not_statically_mock_subclass_with_unmockable_interface() {
        assertThatThrownBy(() -> {
            MockedStatic<DoubleSubclassOfInterface> notMockable = mockStatic(DoubleSubclassOfInterface.class);
        }).isInstanceOf(DoNotMockException.class);
    }
    ...
    public void can_not_statically_mock_subclass_with_unmockable_superclass() {
        assertThatThrownBy(() -> {
            MockedStatic<SubclassOfNotMockableSuperclass> notMockable = mockStatic(SubclassOfNotMockableSuperclass.class);
        }).isInstanceOf(DoNotMockException.class);
    }
    ...
    public void can_not_mock_subclass_with_unmockable_interface_that_extends_non_mockable_interface() {
        assertThatThrownBy(() -> {
            SubclassOfSubInterfaceOfNotMockableInterface notMockable = mock(SubclassOfSubInterfaceOfNotMockableInterface.class);
        }).isInstanceOf(DoNotMockException.class);
    }

    @Test
    public void can_not_statically_mock_subclass_with_unmockable_interface_that_extends_non_mockable_interface() {
        assertThatThrownBy(() -> {
            MockedStatic<SubclassOfSubInterfaceOfNotMockableInterface> notMockable = mockStatic(SubclassOfSubInterfaceOfNotMockableInterface.class);
        }).isInstanceOf(DoNotMockException.class);
    }
    ...
    public void thrown_exception_includes_special_non_mockable_reason_static() {
        assertThatThrownBy(() -> {
            MockedStatic<NotMockableWithReason> notMockable = mockStatic(NotMockableWithReason.class);
        }).isInstanceOf(DoNotMockException.class).hasMessageContaining("Special reason");
    }
    ...
    public void can_not_statically_mock_class_with_custom_donotmock_annotation() {
        assertThatThrownBy(() -> {
            MockedStatic<NotMockableWithDifferentAnnotation> notMockable = mockStatic(NotMockableWithDifferentAnnotation.class);
        }).isInstanceOf(DoNotMockException.class);
    }
    ...
    private static class TestClass {
        ...
        @Mock
        private NotMockable notMockable;
    }
}

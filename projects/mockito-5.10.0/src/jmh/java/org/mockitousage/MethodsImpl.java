...
public class MethodsImpl implements IMethods {
    ...
    public String threeArgumentVarArgsMethod(final int valueOne, final String valueTwo, final String... valueThree) {
        return null;
    }
    ...
    public String fourArgumentVarArgsMethod(final int valueOne, final String valueTwo, final int valueThree, final String... valueFour) {
        return null;
    }

    public String fiveArgumentVarArgsMethod(final int valueOne, final String valueTwo, final int valueThree, final String valueFour, final String... valueFive) {
        return null;
    }

    public String sixArgumentVarArgsMethod(final int valueOne, final String valueTwo, final int valueThree, final String valueFour, final String valueFive, final String... valueSix) {
        return null;
    }

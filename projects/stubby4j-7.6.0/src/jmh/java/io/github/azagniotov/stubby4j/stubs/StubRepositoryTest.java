...
public class StubRepositoryTest {
    ...
    private static final CompletableFuture<YamlParseResultSet> YAML_PARSE_RESULT_SET_FUTURE = CompletableFuture.completedFuture(new YamlParseResultSet(new LinkedList<>(), new HashMap<>()));
    ...
    public void beforeEach() throws Exception {
        ...
        final StubRepository stubRepository = new StubRepository(CONFIG_FILE, Cache.stubHttpLifecycleCache(false), YAML_PARSE_RESULT_SET_FUTURE, mockStubbyHttpTransport);
    ...
    public void shouldMatchProxyConfig_WhenUniqueProxyNameGiven() throws Exception {
        final StubHttpLifecycle httpLifecycle = new StubHttpLifecycle.Builder().withUUID("uuid").withRequest(new StubRequest.Builder().withUrl("/some/uri/path/1").withMethod("GET").build()).withResponse(new StubResponse.Builder().build()).build();
        final StubProxyConfig stubProxyConfigDefault = new StubProxyConfig.Builder().withStrategy("as-is").withPropertyEndpoint("https://jsonplaceholder.typicode.com").build();
        final StubProxyConfig stubProxyConfigOther = new StubProxyConfig.Builder().withUuid("other-unique").withStrategy("as-is").withPropertyEndpoint("https://jsonplaceholder.typicode.com").build();
    ...
    public void shouldUpdateProxyConfigsByUuid() throws Exception {
        final StubHttpLifecycle httpLifecycle = new StubHttpLifecycle.Builder().withUUID("uuid").withRequest(new StubRequest.Builder().withUrl("/some/uri/path/1").withMethod("GET").build()).withResponse(new StubResponse.Builder().build()).build();
        final StubProxyConfig stubProxyConfigDefault = new StubProxyConfig.Builder().withStrategy("as-is").withPropertyEndpoint("https://jsonplaceholder.typicode.com").build();
        final StubProxyConfig stubProxyConfigOne = new StubProxyConfig.Builder().withUuid(STUB_UUID_ONE).withStrategy("as-is").withPropertyEndpoint("https://jsonplaceholder.typicode.com").build();
        final StubProxyConfig stubProxyConfigTwo = new StubProxyConfig.Builder().withUuid(STUB_UUID_TWO).withStrategy("as-is").withPropertyEndpoint("https://jsonplaceholder.typicode.com").build();
        final StubProxyConfig stubProxyConfigThree = new StubProxyConfig.Builder().withUuid(STUB_UUID_THREE).withStrategy("as-is").withPropertyEndpoint("https://jsonplaceholder.typicode.com").build();
        final YamlParseResultSet yamlParseResultSet = new YamlParseResultSet(new LinkedList<StubHttpLifecycle>() {
        ...
        // /////////////////////////////////////////////////////////////////////////////////////
        final StubProxyConfig newStubProxyConfigTwo = new StubProxyConfig.Builder().withUuid(STUB_UUID_TWO).withStrategy("as-is").withPropertyEndpoint("http://google.com").build();
        ...
        // /////////////////////////////////////////////////////////////////////////////////////
        final StubProxyConfig newStubProxyConfigThree = new StubProxyConfig.Builder().withUuid(STUB_UUID_THREE).withStrategy("as-is").withPropertyEndpoint("http://yahoo.com").build();
        ...
        // /////////////////////////////////////////////////////////////////////////////////////
        final StubProxyConfig newStubProxyConfigOne = new StubProxyConfig.Builder().withUuid(STUB_UUID_ONE).withStrategy("as-is").withPropertyEndpoint("http://mail.com").build();
        ...
        // /////////////////////////////////////////////////////////////////////////////////////
        final StubProxyConfig newStubProxyConfigDefault = new StubProxyConfig.Builder().withUuid("default").withStrategy("as-is").withPropertyEndpoint("http://rambler.ru").build();
    ...
    public void shouldUpdateStubsByUuid() throws Exception {
        ...
        // The actual test: update by second UUID (STUB_UUID_TWO)
        // /////////////////////////////////////////////////////////////////////////////////////
        spyStubRepository.updateStubByUuid(STUB_UUID_TWO, parseYaml("/resource/completely/new/item/2", STUB_UUID_TWO).getStubs().get(0));
        assertThat(spyStubRepository.getStubs().size()).isEqualTo(3);
        assertThat(spyStubRepository.canMatchStubByUuid(STUB_UUID_ONE)).isTrue();
        assertThat(spyStubRepository.canMatchStubByUuid(STUB_UUID_TWO)).isTrue();
        assertThat(spyStubRepository.canMatchStubByUuid(STUB_UUID_THREE)).isTrue();
        ...
        // The actual test: update by third UUID (STUB_UUID_THREE)
        // /////////////////////////////////////////////////////////////////////////////////////
        spyStubRepository.updateStubByUuid(STUB_UUID_THREE, parseYaml("/resource/completely/new/item/3", STUB_UUID_THREE).getStubs().get(0));
        assertThat(spyStubRepository.getStubs().size()).isEqualTo(3);
        assertThat(spyStubRepository.canMatchStubByUuid(STUB_UUID_ONE)).isTrue();
        assertThat(spyStubRepository.canMatchStubByUuid(STUB_UUID_TWO)).isTrue();
        assertThat(spyStubRepository.canMatchStubByUuid(STUB_UUID_THREE)).isTrue();
        ...
        // The actual test: update by third UUID (STUB_UUID_ONE)
        // /////////////////////////////////////////////////////////////////////////////////////
        spyStubRepository.updateStubByUuid(STUB_UUID_ONE, parseYaml("/resource/completely/new/item/1", STUB_UUID_ONE).getStubs().get(0));
        assertThat(spyStubRepository.getStubs().size()).isEqualTo(3);
        assertThat(spyStubRepository.canMatchStubByUuid(STUB_UUID_ONE)).isTrue();
        assertThat(spyStubRepository.canMatchStubByUuid(STUB_UUID_TWO)).isTrue();
        assertThat(spyStubRepository.canMatchStubByUuid(STUB_UUID_THREE)).isTrue();
        ...
        spyStubRepository.updateStubByUuid(STUB_UUID_TWO, parseYaml("/resource/completely/new/item/with/new/uuid/2", newUuid).getStubs().get(0));
        assertThat(spyStubRepository.getStubs().size()).isEqualTo(3);
        assertThat(spyStubRepository.canMatchStubByUuid(STUB_UUID_ONE)).isTrue();
        assertThat(spyStubRepository.canMatchStubByUuid(STUB_UUID_TWO)).isFalse();
        assertThat(spyStubRepository.canMatchStubByUuid(STUB_UUID_THREE)).isTrue();
    ...
    public void shouldRecordingUsingIncomingRequestQueryStringAndStubbedRecordableUrl() throws Exception {
        ...
        final StubRequest stubbedRequest = requestBuilder.withUrl("/search").withMethodGet().withHeader("content-type", Common.HEADER_APPLICATION_JSON).withQuery("queryOne", "([a-zA-Z]+)").withQuery("queryTwo", "([1-9]+)").build();
        final YamlParseResultSet yamlParseResultSet = parseYaml(stubbedRequest, responseBuilder.emptyWithBody(sourceToRecord).build(), STUB_UUID_ONE);
        spyStubRepository.resetStubsCache(yamlParseResultSet);
        final String actualResponseText = "OK, this is recorded response text!";
        ...
        final StubRequest incomingRequest = requestBuilder.withUrl("/search").withMethodGet().withHeader("content-type", Common.HEADER_APPLICATION_JSON).withQuery("queryTwo", "12345").withQuery("queryOne", "arbitraryValue").build();
    ...
    public void stubbedRequestEqualsAssertingRequest_WhenQueryParamArrayHasElementsWithinUrlEncodedQuotes() throws Exception {
        ...
        final StubRequest expectedRequest = requestBuilder.withUrl(url).withMethodGet().withMethodHead().withQuery(paramOne, paramOneValue).build();
    ...
    public void stubbedRequestEqualsAssertingRequest_WhenQueryValuesHaveEncodedSinglePlus() throws Exception {
        ...
        final String url = "/invoice/789";
        final StubRequest expectedRequest = requestBuilder.withUrl(url).withMethodGet().withQuery(paramOne, paramOneValue).build();
        when(mockHttpServletRequest.getPathInfo()).thenReturn(url);
        when(mockHttpServletRequest.getMethod()).thenReturn(HttpMethods.GET);
    ...
    public void stubbedRequestEqualsAssertingRequest_WhenQueryValues_HasArrayElementsWithEncodedSpacesWithinUrlEncodedSingleQuotes() throws Exception {
        ...
        final String encodedRawQuery = paramOneValue.replaceAll("\\s+", "%20%20").replaceAll(Pattern.quote("["), "%5B").replaceAll("\\]", "%5D").replaceAll("'", "%27");
        final String url = "/invoice/789";
        final StubRequest expectedRequest = requestBuilder.withUrl(url).withMethodGet().withMethodHead().withQuery(paramOne, paramOneValue).build();
        when(mockHttpServletRequest.getPathInfo()).thenReturn(url);
        when(mockHttpServletRequest.getMethod()).thenReturn(HttpMethods.GET);
    ...
    public void stubbedRequestEqualsAssertingRequest_WhenQueryValues_HasArrayElementsWithEncodedPlusWithinUrlEncodedSingleQuotes() throws Exception {
        final String paramOne = "names";
        final String paramOneValue = "['stalin and truman','are best friends']";
        final String encodedRawQuery = paramOneValue.replaceAll("\\s+", "%2B%2B%2B").replaceAll(Pattern.quote("["), "%5B").replaceAll("\\]", "%5D").replaceAll("'", "%27");
        final String url = "/invoice/789";
        final StubRequest expectedRequest = requestBuilder.withUrl(url).withMethodGet().withMethodHead().withQuery(paramOne, paramOneValue).build();
        when(mockHttpServletRequest.getPathInfo()).thenReturn(url);
        when(mockHttpServletRequest.getMethod()).thenReturn(HttpMethods.GET);
    ...
    public void shouldApplyDefaultProxyConfigToHttpTransport_WhenResponseIsProxiable() throws Exception {
        final StubHttpLifecycle httpLifecycle = new StubHttpLifecycle.Builder().withUUID("uuid").withRequest(new StubRequest.Builder().withUrl("/some/uri/path/1").withMethod("GET").build()).withResponse(new StubResponse.Builder().build()).build();
        final StubProxyConfig stubProxyConfig = new StubProxyConfig.Builder().withStrategy("as-is").withPropertyEndpoint("https://jsonplaceholder.typicode.com").build();
        final YamlParseResultSet yamlParseResultSet = new YamlParseResultSet(new LinkedList<StubHttpLifecycle>() {
        ...
        final StubRequest incomingRequest = requestBuilder.withUrl("/post/1").withMethodGet().withHeader("content-type", Common.HEADER_APPLICATION_JSON).build();
        doReturn(incomingRequest).when(spyStubRepository).toStubRequest(any(HttpServletRequest.class));
        final StubSearchResult stubSearchResult = spyStubRepository.search(mockHttpServletRequest);
    ...
    public void shouldApplyProxyConfigAdditiveStrategyHeadersToHttpTransport_WhenResponseIsProxiable() throws Exception {
        final StubHttpLifecycle httpLifecycle = new StubHttpLifecycle.Builder().withUUID("uuid").withRequest(new StubRequest.Builder().withUrl("/some/uri/path/1").withMethod("GET").build()).withResponse(new StubResponse.Builder().build()).build();
        final StubProxyConfig stubProxyConfig = new StubProxyConfig.Builder().withStrategy("additive").withHeader("x-custom-header", "something/unique").withHeader("x-custom-header-2", "another/thing").withPropertyEndpoint("https://jsonplaceholder.typicode.com").build();
        final YamlParseResultSet yamlParseResultSet = new YamlParseResultSet(new LinkedList<StubHttpLifecycle>() {
    ...
    public void shouldNotApplyProxyConfigAdditiveStrategyEmptyHeadersToHttpTransport_WhenResponseIsProxiable() throws Exception {
        final StubHttpLifecycle httpLifecycle = new StubHttpLifecycle.Builder().withUUID("uuid").withRequest(new StubRequest.Builder().withUrl("/some/uri/path/1").withMethod("GET").build()).withResponse(new StubResponse.Builder().build()).build();
        final StubProxyConfig stubProxyConfig = new StubProxyConfig.Builder().withStrategy("additive").withPropertyEndpoint("https://jsonplaceholder.typicode.com").build();
        final YamlParseResultSet yamlParseResultSet = new YamlParseResultSet(new LinkedList<StubHttpLifecycle>() {
    ...
    public void shouldApplyProxyConfigByProxyConfigUuidHeaderToHttpTransport_WhenResponseIsProxiable() throws Exception {
        final StubHttpLifecycle httpLifecycle = new StubHttpLifecycle.Builder().withUUID("uuid").withRequest(new StubRequest.Builder().withUrl("/some/uri/path/1").withMethod("GET").build()).withResponse(new StubResponse.Builder().build()).build();
        final StubProxyConfig defaultStubProxyConfig = new StubProxyConfig.Builder().withStrategy("as-is").withPropertyEndpoint("https://jsonplaceholder.typicode.com").build();
        final StubProxyConfig anotherStubProxyConfig = new StubProxyConfig.Builder().withDescription("This is another configured proxy").withUuid("unique-no-default-proxy-config-uuid").withStrategy("as-is").withPropertyEndpoint("https://google.com").build();
        final YamlParseResultSet yamlParseResultSet = new YamlParseResultSet(new LinkedList<StubHttpLifecycle>() {
        ...
        httpProxyResponseHeaders.put("SomeHeader", Arrays.asList("one", "two"));
        when(mockStubbyHttpTransport.httpRequestFromStub(any(StubRequest.class), anyString())).thenReturn(new StubbyResponse(201, actualResponseText, httpProxyResponseHeaders));
        final StubRequest incomingRequest = requestBuilder.withUrl("/post/1").withMethodGet().withHeader("content-type", Common.HEADER_APPLICATION_JSON).withHeader(HEADER_X_STUBBY_PROXY_CONFIG, anotherStubProxyConfig.getUUID()).build();
        doReturn(incomingRequest).when(spyStubRepository).toStubRequest(any(HttpServletRequest.class));
        final StubSearchResult stubSearchResult = spyStubRepository.search(mockHttpServletRequest);
        final StubResponse proxiedResponse = stubSearchResult.getMatch();
        assertThat(proxiedResponse.getBody()).isEqualTo(actualResponseText);
    ...
    public void shouldApplyDefaultProxyConfigWhenProxyConfigUuidHeaderIncorrectToHttpTransport_WhenResponseIsProxiable() throws Exception {
        ...
        httpProxyResponseHeaders.put("SomeHeader", Arrays.asList("one", "two"));
        when(mockStubbyHttpTransport.httpRequestFromStub(any(StubRequest.class), anyString())).thenReturn(new StubbyResponse(201, actualResponseText, httpProxyResponseHeaders));
        final StubRequest incomingRequest = requestBuilder.withUrl("/post/1").withMethodGet().withHeader("content-type", Common.HEADER_APPLICATION_JSON).withHeader(HEADER_X_STUBBY_PROXY_CONFIG, "WrongStubProxyConfigHeaderUUID").build();
        doReturn(incomingRequest).when(spyStubRepository).toStubRequest(any(HttpServletRequest.class));
        final StubSearchResult stubSearchResult = spyStubRepository.search(mockHttpServletRequest);
        final StubResponse proxiedResponse = stubSearchResult.getMatch();
        assertThat(proxiedResponse.getBody()).isEqualTo(actualResponseText);
    ...
    private YamlParseResultSet parseYaml(final String url, final StubResponse stubResponse, final String uuid) throws Exception {
        final StubRequest stubRequest = requestBuilder.withUrl(url).withMethodGet().withHeader("content-type", Common.HEADER_APPLICATION_JSON).build();
    ...
    private YamlParseResultSet parseYaml(final StubRequest stubRequest, final StubResponse stubResponse, final String uuid) throws Exception {
        ...
        stubBuilder.withRequest(stubRequest).withResponse(stubResponse).withUUID(uuid).withCompleteYAML("This is marshalled yaml snippet");
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_shouldGetResourceStatsAsCsv() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldGetResourceStatsAsCsv, this.description("shouldGetResourceStatsAsCsv"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_canMatchHttpCycleByUuid() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::canMatchHttpCycleByUuid, this.description("canMatchHttpCycleByUuid"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldExpungeOriginalHttpCycleList_WhenNewHttpCyclesGiven() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldExpungeOriginalHttpCycleList_WhenNewHttpCyclesGiven, this.description("shouldExpungeOriginalHttpCycleList_WhenNewHttpCyclesGiven"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldMatchHttplifecycle_WhenValidIndexGiven() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldMatchHttplifecycle_WhenValidIndexGiven, this.description("shouldMatchHttplifecycle_WhenValidIndexGiven"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldNotMatchHttplifecycle_WhenInvalidIndexGiven() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldNotMatchHttplifecycle_WhenInvalidIndexGiven, this.description("shouldNotMatchHttplifecycle_WhenInvalidIndexGiven"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldMatchProxyConfig_WhenUniqueProxyNameGiven() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldMatchProxyConfig_WhenUniqueProxyNameGiven, this.description("shouldMatchProxyConfig_WhenUniqueProxyNameGiven"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldDeleteOriginalHttpCycleList_WhenValidIndexGiven() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldDeleteOriginalHttpCycleList_WhenValidIndexGiven, this.description("shouldDeleteOriginalHttpCycleList_WhenValidIndexGiven"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldDeleteOriginalHttpCycleList_WhenStubsExist() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldDeleteOriginalHttpCycleList_WhenStubsExist, this.description("shouldDeleteOriginalHttpCycleList_WhenStubsExist"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldDeleteOriginalHttpCycleList_WhenStubsDontExist() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldDeleteOriginalHttpCycleList_WhenStubsDontExist, this.description("shouldDeleteOriginalHttpCycleList_WhenStubsDontExist"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldDeleteOriginalHttpCycleList_WhenInvalidIndexGiven() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldDeleteOriginalHttpCycleList_WhenInvalidIndexGiven, this.description("shouldDeleteOriginalHttpCycleList_WhenInvalidIndexGiven"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldDeleteStubsByUuid() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldDeleteStubsByUuid, this.description("shouldDeleteStubsByUuid"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldUpdateProxyConfigsByUuid() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldUpdateProxyConfigsByUuid, this.description("shouldUpdateProxyConfigsByUuid"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldFailUpdatingProxyConfigByUuidWhenUuidDoNotMatch() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldFailUpdatingProxyConfigByUuidWhenUuidDoNotMatch, this.description("shouldFailUpdatingProxyConfigByUuidWhenUuidDoNotMatch"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldDeleteProxyConfigsByUuid() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldDeleteProxyConfigsByUuid, this.description("shouldDeleteProxyConfigsByUuid"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldFailDeletingDefaultProxyConfigByUuid() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldFailDeletingDefaultProxyConfigByUuid, this.description("shouldFailDeletingDefaultProxyConfigByUuid"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldUpdateStubsByUuid() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldUpdateStubsByUuid, this.description("shouldUpdateStubsByUuid"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldVerifyExpectedHttpLifeCycles_WhenRefreshingStubbedData() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldVerifyExpectedHttpLifeCycles_WhenRefreshingStubbedData, this.description("shouldVerifyExpectedHttpLifeCycles_WhenRefreshingStubbedData"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldGetMarshalledYamlByIndex_WhenValidHttpCycleListIndexGiven() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldGetMarshalledYamlByIndex_WhenValidHttpCycleListIndexGiven, this.description("shouldGetMarshalledYamlByIndex_WhenValidHttpCycleListIndexGiven"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldFailToGetMarshalledYamlByIndex_WhenInvalidHttpCycleListIndexGiven() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldFailToGetMarshalledYamlByIndex_WhenInvalidHttpCycleListIndexGiven, this.description("shouldFailToGetMarshalledYamlByIndex_WhenInvalidHttpCycleListIndexGiven"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldUpdateStubHttpLifecycleByIndex_WhenValidHttpCycleListIndexGiven() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldUpdateStubHttpLifecycleByIndex_WhenValidHttpCycleListIndexGiven, this.description("shouldUpdateStubHttpLifecycleByIndex_WhenValidHttpCycleListIndexGiven"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldUpdateStubHttpLifecycleByIndex_WhenInvalidHttpCycleListIndexGiven() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldUpdateStubHttpLifecycleByIndex_WhenInvalidHttpCycleListIndexGiven, this.description("shouldUpdateStubHttpLifecycleByIndex_WhenInvalidHttpCycleListIndexGiven"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldUpdateStubResponseBody_WhenResponseIsRecordable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldUpdateStubResponseBody_WhenResponseIsRecordable, this.description("shouldUpdateStubResponseBody_WhenResponseIsRecordable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldNotUpdateStubResponseBody_WhenResponseIsNotRecordable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldNotUpdateStubResponseBody_WhenResponseIsNotRecordable, this.description("shouldNotUpdateStubResponseBody_WhenResponseIsNotRecordable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldRecordingUsingIncomingRequestQueryStringAndStubbedRecordableUrl() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldRecordingUsingIncomingRequestQueryStringAndStubbedRecordableUrl, this.description("shouldRecordingUsingIncomingRequestQueryStringAndStubbedRecordableUrl"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldNotUpdateStubResponseBody_WhenResponseIsRecordableButExceptionThrown() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldNotUpdateStubResponseBody_WhenResponseIsRecordableButExceptionThrown, this.description("shouldNotUpdateStubResponseBody_WhenResponseIsRecordableButExceptionThrown"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_stubbedRequestEqualsAssertingRequest_WhenQueryParamArrayHasElementsWithinUrlEncodedQuotes() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::stubbedRequestEqualsAssertingRequest_WhenQueryParamArrayHasElementsWithinUrlEncodedQuotes, this.description("stubbedRequestEqualsAssertingRequest_WhenQueryParamArrayHasElementsWithinUrlEncodedQuotes"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_stubbedRequestEqualsAssertingRequest_WhenQueryParamUrlEncodedArrayHasElementsWithinUrlEncodedQuotes() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::stubbedRequestEqualsAssertingRequest_WhenQueryParamUrlEncodedArrayHasElementsWithinUrlEncodedQuotes, this.description("stubbedRequestEqualsAssertingRequest_WhenQueryParamUrlEncodedArrayHasElementsWithinUrlEncodedQuotes"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_stubbedRequestEqualsAssertingRequest_WhenQueryParamUrlEncodedArrayHasElementsWithinUrlEncodedSingleQuotes() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::stubbedRequestEqualsAssertingRequest_WhenQueryParamUrlEncodedArrayHasElementsWithinUrlEncodedSingleQuotes, this.description("stubbedRequestEqualsAssertingRequest_WhenQueryParamUrlEncodedArrayHasElementsWithinUrlEncodedSingleQuotes"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_stubbedRequestEqualsAssertingRequest_WhenQueryValuesHaveEncodedSinglePlus() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::stubbedRequestEqualsAssertingRequest_WhenQueryValuesHaveEncodedSinglePlus, this.description("stubbedRequestEqualsAssertingRequest_WhenQueryValuesHaveEncodedSinglePlus"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_stubbedRequestEqualsAssertingRequest_WhenQueryValuesHaveMultipleRawPluses() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::stubbedRequestEqualsAssertingRequest_WhenQueryValuesHaveMultipleRawPluses, this.description("stubbedRequestEqualsAssertingRequest_WhenQueryValuesHaveMultipleRawPluses"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_stubbedRequestEqualsAssertingRequest_WhenQueryValuesHaveEncodedMultiplePluses() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::stubbedRequestEqualsAssertingRequest_WhenQueryValuesHaveEncodedMultiplePluses, this.description("stubbedRequestEqualsAssertingRequest_WhenQueryValuesHaveEncodedMultiplePluses"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_stubbedRequestEqualsAssertingRequest_WhenQueryValues_HasArrayElementsWithEncodedSpacesWithinUrlEncodedSingleQuotes() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::stubbedRequestEqualsAssertingRequest_WhenQueryValues_HasArrayElementsWithEncodedSpacesWithinUrlEncodedSingleQuotes, this.description("stubbedRequestEqualsAssertingRequest_WhenQueryValues_HasArrayElementsWithEncodedSpacesWithinUrlEncodedSingleQuotes"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_stubbedRequestEqualsAssertingRequest_WhenQueryValues_HasArrayElementsWithEncodedPlusWithinUrlEncodedSingleQuotes() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::stubbedRequestEqualsAssertingRequest_WhenQueryValues_HasArrayElementsWithEncodedPlusWithinUrlEncodedSingleQuotes, this.description("stubbedRequestEqualsAssertingRequest_WhenQueryValues_HasArrayElementsWithEncodedPlusWithinUrlEncodedSingleQuotes"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldApplyDefaultProxyConfigToHttpTransport_WhenResponseIsProxiable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldApplyDefaultProxyConfigToHttpTransport_WhenResponseIsProxiable, this.description("shouldApplyDefaultProxyConfigToHttpTransport_WhenResponseIsProxiable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldApplyProxyConfigAdditiveStrategyHeadersToHttpTransport_WhenResponseIsProxiable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldApplyProxyConfigAdditiveStrategyHeadersToHttpTransport_WhenResponseIsProxiable, this.description("shouldApplyProxyConfigAdditiveStrategyHeadersToHttpTransport_WhenResponseIsProxiable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldNotApplyProxyConfigAdditiveStrategyEmptyHeadersToHttpTransport_WhenResponseIsProxiable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldNotApplyProxyConfigAdditiveStrategyEmptyHeadersToHttpTransport_WhenResponseIsProxiable, this.description("shouldNotApplyProxyConfigAdditiveStrategyEmptyHeadersToHttpTransport_WhenResponseIsProxiable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldApplyProxyConfigByProxyConfigUuidHeaderToHttpTransport_WhenResponseIsProxiable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldApplyProxyConfigByProxyConfigUuidHeaderToHttpTransport_WhenResponseIsProxiable, this.description("shouldApplyProxyConfigByProxyConfigUuidHeaderToHttpTransport_WhenResponseIsProxiable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldApplyDefaultProxyConfigWhenProxyConfigUuidHeaderIncorrectToHttpTransport_WhenResponseIsProxiable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldApplyDefaultProxyConfigWhenProxyConfigUuidHeaderIncorrectToHttpTransport_WhenResponseIsProxiable, this.description("shouldApplyDefaultProxyConfigWhenProxyConfigUuidHeaderIncorrectToHttpTransport_WhenResponseIsProxiable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldPassDefaultProxyConfigStateToHttpTransport_WhenResponseIsProxiableButExceptionThrows() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldPassDefaultProxyConfigStateToHttpTransport_WhenResponseIsProxiableButExceptionThrows, this.description("shouldPassDefaultProxyConfigStateToHttpTransport_WhenResponseIsProxiableButExceptionThrows"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_stubbedRequestNotEqualsAssertingRequest_WhenQueryParamArrayElementsHaveDifferentSpacing() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::stubbedRequestNotEqualsAssertingRequest_WhenQueryParamArrayElementsHaveDifferentSpacing, this.description("stubbedRequestNotEqualsAssertingRequest_WhenQueryParamArrayElementsHaveDifferentSpacing"));
        }

        @java.lang.Override
        public void before() throws java.lang.Throwable {
            super.before();
            this.implementation().beforeEach();
        }
        ...
        private StubRepositoryTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new StubRepositoryTest();
        }

        @java.lang.Override
        public StubRepositoryTest implementation() {

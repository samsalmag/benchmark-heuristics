...
public class RegexParserTest {
    ...
    public void shouldMatchSubjectWithMultiline() throws Exception {
        final String testSubject = "Biggest tech companies in the world by their market value as of 2018:" + BR + "Apple: $741.8 billion. In 2014, Apple, Inc. introduced a programming language called Swift." + BR + "In 2015, the company made Swift open-source, which allowed non-Apple developers to work " + "on the project." + BR + "Record-breaking three-day sales of 13 million units of the company’s " + "iPhone 6s and iPhone 6s Plus were announced in October 2015." + BR + BR + "Alphabet: $367.6 billion. In October 2015, Google restructured the company so that Alphabet, Inc." + BR + "became the parent company under which Google operates. Alphabet owns all of Google's side projects," + BR + "such as life-extension company Calico, innovative technology developer Google X, high-speed Internet" + BR + "provider Fiber and Google's smart home project Nest.";
        ...
        assertThat(regexGroups.get("token.2").trim()).isEqualTo("$741.8 billion. In 2014, Apple, Inc. introduced a programming language called Swift." + BR + "In 2015, the company made Swift open-source, which allowed non-Apple developers to work " + "on the project." + BR + "Record-breaking three-day sales of 13 million units of the company’s " + "iPhone 6s and iPhone 6s Plus were announced in October 2015.");
        assertThat(regexGroups.get("token.3").trim()).isEqualTo("$367.6 billion. In October 2015, Google restructured the company so that Alphabet, Inc." + BR + "became the parent company under which Google operates. Alphabet owns all of Google's side projects," + BR + "such as life-extension company Calico, innovative technology developer Google X, high-speed Internet" + BR + "provider Fiber and Google's smart home project Nest.");
    }
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_shouldDetermineStringAsPotentialRegexPatterns() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldDetermineStringAsPotentialRegexPatterns, this.description("shouldDetermineStringAsPotentialRegexPatterns"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldNotMatchWhenRegexPatternWithSyntaxError() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldNotMatchWhenRegexPatternWithSyntaxError, this.description("shouldNotMatchWhenRegexPatternWithSyntaxError"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldMatchSubjectWithMultiline() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldMatchSubjectWithMultiline, this.description("shouldMatchSubjectWithMultiline"));
        }

        private RegexParserTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new RegexParserTest();
        }

        @java.lang.Override
        public RegexParserTest implementation() {

...
public class DefaultResponseHandlingStrategyTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_shouldVerifyBehaviourWhenHandlingDefaultResponseWithoutLatency() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldVerifyBehaviourWhenHandlingDefaultResponseWithoutLatency, this.description("shouldVerifyBehaviourWhenHandlingDefaultResponseWithoutLatency"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldVerifyBehaviourWhenHandlingDefaultResponseWithLatency() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldVerifyBehaviourWhenHandlingDefaultResponseWithLatency, this.description("shouldVerifyBehaviourWhenHandlingDefaultResponseWithLatency"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldCheckLatencyDelayWhenHandlingDefaultResponseWithLatency() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldCheckLatencyDelayWhenHandlingDefaultResponseWithLatency, this.description("shouldCheckLatencyDelayWhenHandlingDefaultResponseWithLatency"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldReturnReplacedValueInResponseHeaderWhenRequestBodyHasDynamicToken() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldReturnReplacedValueInResponseHeaderWhenRequestBodyHasDynamicToken, this.description("shouldReturnReplacedValueInResponseHeaderWhenRequestBodyHasDynamicToken"));
        }

        private DefaultResponseHandlingStrategyTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new DefaultResponseHandlingStrategyTest();
        }

        @java.lang.Override
        public DefaultResponseHandlingStrategyTest implementation() {

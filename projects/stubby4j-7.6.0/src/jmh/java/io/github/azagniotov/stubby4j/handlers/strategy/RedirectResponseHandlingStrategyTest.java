...
public class RedirectResponseHandlingStrategyTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_shouldVerifyBehaviourWhenHandlingTemporaryRedirectResponseWithoutLatency() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldVerifyBehaviourWhenHandlingTemporaryRedirectResponseWithoutLatency, this.description("shouldVerifyBehaviourWhenHandlingTemporaryRedirectResponseWithoutLatency"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldVerifyBehaviourWhenHandlingPermanentRedirectResponseWithoutLatency() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldVerifyBehaviourWhenHandlingPermanentRedirectResponseWithoutLatency, this.description("shouldVerifyBehaviourWhenHandlingPermanentRedirectResponseWithoutLatency"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldVerifyBehaviourWhenHandlingRedirectResponseWithLatency() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldVerifyBehaviourWhenHandlingRedirectResponseWithLatency, this.description("shouldVerifyBehaviourWhenHandlingRedirectResponseWithLatency"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_shouldReturnReplacedValueInLocationHeaderWhenQueryParamHasDynamicToken() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::shouldReturnReplacedValueInLocationHeaderWhenQueryParamHasDynamicToken, this.description("shouldReturnReplacedValueInLocationHeaderWhenQueryParamHasDynamicToken"));
        }
        ...
        private RedirectResponseHandlingStrategyTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new RedirectResponseHandlingStrategyTest();
        }

        @java.lang.Override
        public RedirectResponseHandlingStrategyTest implementation() {

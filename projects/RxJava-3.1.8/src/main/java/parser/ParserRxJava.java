...
public class ParserRxJava {
    ...
    public static void main(String[] args) {
        ...
        benchmarkParser.parseBenchmarks(parser, 0, 249, "benchmarks\\results\\rxjava_parsedBenchmarks1.json");
        benchmarkParser.parseBenchmarks(parser, 250, 499, "benchmarks\\results\\rxjava_parsedBenchmarks2.json");
        benchmarkParser.parseBenchmarks(parser, 500, 750, "benchmarks\\results\\rxjava_parsedBenchmarks3.json");
    }
}

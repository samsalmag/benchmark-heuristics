...
public class FlowableOnBackpressureBufferStrategyTest extends RxJavaTest {
    ...
    public static class _Benchmark extends io.reactivex.rxjava3.core.RxJavaTest._Benchmark {
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_onDroppedNormalDropOldest() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::onDroppedNormalDropOldest, this.description("onDroppedNormalDropOldest"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_onDroppedNormalDropLatest() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::onDroppedNormalDropLatest, this.description("onDroppedNormalDropLatest"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_onDroppedNormalError() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::onDroppedNormalError, this.description("onDroppedNormalError"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_onDroppedCrash() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::onDroppedCrash, this.description("onDroppedCrash"));
        }

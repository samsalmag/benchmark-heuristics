...
public class SchedulerTest {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_driftUseNanoTimeNotSetByDefault() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::driftUseNanoTimeNotSetByDefault, this.description("driftUseNanoTimeNotSetByDefault"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_computeNow_currentTimeMillis() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::computeNow_currentTimeMillis, this.description("computeNow_currentTimeMillis"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_computeNow_nanoTime() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::computeNow_nanoTime, this.description("computeNow_nanoTime"));
        }

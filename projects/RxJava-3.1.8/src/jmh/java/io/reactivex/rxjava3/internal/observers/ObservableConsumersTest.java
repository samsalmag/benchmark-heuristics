...
public class ObservableConsumersTest implements Consumer<Object>, Action {
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_onErrorNormal() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::onErrorNormal, this.description("onErrorNormal"));
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_onCompleteNormal() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::onCompleteNormal, this.description("onCompleteNormal"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_onCompleteError() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::onCompleteError, this.description("onCompleteError"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_onCompleteDispose() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::onCompleteDispose, this.description("onCompleteDispose"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_onNextCrash() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::onNextCrash, this.description("onNextCrash"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_onNextCrashOnError() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::onNextCrashOnError, this.description("onNextCrashOnError"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_onNextCrashNoError() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::onNextCrashNoError, this.description("onNextCrashNoError"));
        }
        ...
        private ObservableConsumersTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObservableConsumersTest();
        }

        @java.lang.Override
        public ObservableConsumersTest implementation() {
